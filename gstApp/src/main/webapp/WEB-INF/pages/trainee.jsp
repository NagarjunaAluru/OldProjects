		...
		<div class="MainBody">
		  ...
		  <div class="tab-content">
			...
			<form method="post" action="#" enctype="multipart/form-data"> 
	              <h2 align="center">Upload Training Documents</h2></br>
	            <table align="center">
                    <tr>
                        <td>Training name</td>
           	 ...
           	 <tr>
                        <td>Upload File</td> 
                        <td><input type="file"  size="30" id="file"  ng-model ="training.trainingFile"  required/>
                  ...
                  <tr>
                        <td><input type="button" ng-click="createTraining(training)" value="Upload" class="btn btn-danger btn-sm"/>
								  </td><!--createTraining(training)  -->
                    </tr> 
	            </table>
	      </form>
			</div>
