				...
				<c:if test="${derivativeAtmtPermissions.viewable}">
					<tr>
						<td>
							...
							<a href="#" class="trade-ticket-expand"></a>Derivative Attachments
						</td>
							
						<td  class="multi" colspan="3">
							<div class="trade-ticket-container">
								<div id="Derivative_Trade_Ticket" >
									<c:forEach var="derivative" items="${atmtfunctions:getDerivatives(legIndex, pageContext.request)}" varStatus="derivativeStatus">
										<c:forEach var="derivativeAttachment" items="${derivative.attachments}">
											<div class="icfpAttachment">
												...
												Derivative <${derivativeStatus.count}>&nbsp;-&nbsp;
...
<div class="row">
	<div class="span12">
	 	<table class="table table-striped table-bordered no-bottom">
			...
			<tbody>
				<%-- Journal Entries --%>	
				<c:set var="journaAtmtPermissions" value="${atmtfunctions:getLegAttachmentPermissions(7, legIndex, pageContext.request)}" />
					...
					<tr>
						...
						<td>
							<div id="Journal_Entries" class="icfpAttachmentArea">
								<c:set var="journalEntriesList" value="${atmtfunctions:getLegAttachments(7, legIndex, pageContext.request)}" />
								<c:choose>
