...
!function( $ ){
  ...
  , select: function () {
     ...
     if(this.$element.attr('class')=="span2 amount"){
    	  coverttoUSD($("[data-for='amount']"));
      }	 
      
      if(this.$element.attr('class')=="span2 dayOneCurrency"){
    	  coverttoUSD($("[data-for='dayOneCurrency']"));
      }	  

      if(this.$element.attr('class')=="span2 originalCCY"){
    	  coverttoUSD($("[data-for='originalCCY']"));
      }	  
      
      if(this.$element.attr('class')=="span2 facilityCurrency"){
    	  coverttoUSD($("#facilityIncDecAmt"));
    	  coverttoUSD($("#currencyAmt"));
    	  convertAmendedFacilityAmt();
      }	  
      return this.hide()
    }
    ...
    $.post( url, data, function(data){
        ...
        if(loadPos == "#usdEquiDiv"){
            if(productType == "2"){
                    ...
                    if(content.html()!=undefined && content.html().search(/Yes/i)!='-1') {
...
function convertAmendedFacilityAmt(){
