...
;(function($) {
    ...
    $.zdate = function(element, options) {
        ...
        var view, datepicker, icon, header, daypicker, monthpicker, yearpicker, current_system_month, current_system_year,
            ...
            last_selectable_year, last_selectable_month;
 ...
 */
        ...
        var generate_monthpicker = function() {
            ...
            for (var i = 0; i < 12; i++) {
                ...
                else if (default_month && default_month == i && default_year == selected_year) class_name += ' dp_selected';
            ...
            monthpicker.animate({opacity: 'show',height: 'show'},300);
