...
<script> var servletContextUrl = '<%=servletContextUrl%>';</script>
		...
		<div class="form-mod entitylookup">
					...
					<div class="row">
						<div class="span search-container">
							<div class="form-row">
								...
								<select disabled="disabled" class="span14 cpa-search-id entity-filtername" id="newLenderSearchId">
         ...
         <div id="newLenderTreasuryDetails">
				<div class="row highlighted">
					<div class="span5">
						<div class="form-row">
					...
					<div class="row">
						<div class="span search-container">
							<div class="form-row">
								...
								<select disabled="disabled" class="span14 cpa-search-id entity-filtername" id="newBorrowerSearchId">
