...
<c:set var="legSummaryVO" value="${deal:fetchLegSummary(requestScope.legNumber, pageContext.request)}" scope="page"/>
    ...
    <h2 class="span12">Original <c:if test="${legSummaryVO.legTypeId eq 1}"> Lender </c:if>
					...
					<div class="row">
						<div class="span search-container">
							<div class="form-row">
								...
								<label>Original <c:if test="${legSummaryVO.legTypeId eq 1}"> Lender </c:if>
												<c:if test="${legSummaryVO.legTypeId eq 2}"> Provider </c:if>
												<c:if test="${legSummaryVO.legTypeId eq 6}"> Purchaser </c:if>
												<c:if test="${legSummaryVO.legTypeId eq 5}"> Lender </c:if>
			...
			<div class="span5 right">
				<div class="form-row">
					...
					<select disabled="disabled" class="span2">
						...
						<c:if test="${not empty legSummaryVO.lenderFCHC}">${legSummaryVO.lenderFCHC}</c:if></option>
 					</select> 
       ...
       <h2 class="span12">Original <c:if test="${legSummaryVO.legTypeId eq 1}"> Borrower </c:if>
			...
			<div id="1a" class="tab-content">
					<div class="row">
						<div class="span search-container">
							<div class="form-row">
								<span class="required">*</span>
								<label>Original <c:if test="${legSummaryVO.legTypeId eq 1}"> Borrower </c:if>
													<c:if test="${legSummaryVO.legTypeId eq 2}"> Recipient </c:if>
													<c:if test="${legSummaryVO.legTypeId eq 6}"> Issuer </c:if>
													<c:if test="${legSummaryVO.legTypeId eq 5}"> Borrower </c:if>
			...
			<div class="span5 right">
				<div class="form-row">
					...
					<select disabled="disabled" class="span2">
						...
						<c:if test="${not empty legSummaryVO.borrowerFCHC}">${legSummaryVO.borrowerFCHC}</c:if></option>
 					</select> 
