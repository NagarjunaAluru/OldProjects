...
<script src="<%=servletContextUrl%>/js/day2/rcaTCMOAssignment.js" type="text/javascript"></script>
  ...
  <body>
	<div class="container main">
		...
		<p class="span12 left clear dashdesc">
			Complete ${legSummaryVO.transactionEventType} details below. <span class="required-fields"><span>*</span>= Required</span>
		</p>
		...
		<jsp:include page="/jsp/day2/common/originalTCMOLenderBorrower.jsp" >
         ...
         <jsp:include page="/jsp/day2/common/newTPLenderBorrower.jsp"  >
			 ...
			 <jsp:include page="/jsp/day2/common/derivativesDetails.jsp" >
				<jsp:param name="id" value="${legNumber }"/>
				<jsp:param name="source" value="transactionCapture/transactionCaptureMOFourBlocker"/>
			</jsp:include>
			<jsp:include page="/jsp/day2/common/tpSettlementDetails.jsp">
				<jsp:param name="id" value="${legNumber }"/>
			</jsp:include>
				
		
			 <jsp:include page="/jsp/day2/common/tpTermsAndConditions.jsp" >
				<jsp:param name="id" value="${legNumber }"/>
			</jsp:include>
