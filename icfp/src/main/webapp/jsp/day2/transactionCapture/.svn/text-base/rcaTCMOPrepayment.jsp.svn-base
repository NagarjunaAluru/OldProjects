...
<script src="<%=servletContextUrl%>/js/day2/rcaTCMOPrepayment.js" type="text/javascript"></script>	
		...
		<div class="row">
			<div class="span5">
				<label>Accrued Interest Amount</label>
                    ...
                    <c:if test="${not empty legSummaryVO.accruedInterestAmt}"><fmt:formatNumber value="${legSummaryVO.accruedInterestAmt}" /></c:if>            </div>
            <div class="span5 right">
