...
<script src="<%=servletContextUrl%>/js/day2/rcaTCMOGenAmendment.js" type="text/javascript"></script>	
...
var legLen = '<%=legLenforJS%>';
  ...
  <body>
	<div class="container main">
		...
		<h1 class="page-title span12">Amendment: ${legSummaryVO.transactionEventType}</h1>
		<p class="span12 left clear dashdesc">
			Complete Amendment details below. <span class="required-fields"><span>*</span>= Required</span>
		</p>
		...
		<jsp:include page="/jsp/day2/common/originalTPUsdTransactionDetails.jsp" />
