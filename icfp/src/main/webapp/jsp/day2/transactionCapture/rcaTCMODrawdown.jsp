...
<script src="<%=servletContextUrl%>/js/day2/rcaTCMODrawdown.js" type="text/javascript"></script>	
	   ...
	   <h2 class="span12">Drawdown Details</h2>
		...
		<div class="row highlighted">
			...
			<div class="span5 right ">
				...
				<c:if test="${empty deal:getDrawdownValDt(requestScope.legNumber, pageContext.request)}">-</c:if>
					<c:if test="${not empty deal:getDrawdownValDt(requestScope.legNumber, pageContext.request)}">${deal:getDrawdownValDt(requestScope.legNumber, pageContext.request)}</c:if>
			</div>
		</div>
