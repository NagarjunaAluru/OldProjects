...
<script src="<%=servletContextUrl%>/js/day2/rcaCashMgmtEvents.js" type="text/javascript"></script>
<script>
...
$(document).ready(function() {
	...
	<form id="legSummary"  action="${context}/cashManagement/cashManagementLeg.do" method="post"   enctype="multipart/form-data">
		...
		<c:if test="${param.eventType eq 11}">
			...
			<jsp:include page="../../common/inc/qualitativeAssessment_LegSummary.jsp">
				<jsp:param name="factors" value="Operational Risk - Initial"/>
			...
			<div class="form-mod">
				<jsp:include page="../../common/inc/commentsLog.jsp">
			        ...
			        <jsp:param value="Cash Management" name="origin"/>
			...
			<div class="span12 btn-container" style="margin-left:-10px!important;">
				<c:if test="${sessionScope.section eq 'myTasks'}">
					<div class="span3 right" style="background-color: #D9EDF7;   border:1px solid #A6C2D6;padding:5px;">
						...
						<input type="button" value="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Submit&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" class="btn btn-success btn-large" onclick="javascript:saveCashMgmt(this);">
					</div>
					<c:choose>
      ...
      <div class="modal hide fade" id="cancelpopup">
		...
		<div class="modal-footer">
			<a href="${context}/cashManagement/cashManagement.do?command=load&DealRequestID=${sessionScope.deal.dealSeqId}" class="btn right btn-success">Yes, cancel the Leg</a>
