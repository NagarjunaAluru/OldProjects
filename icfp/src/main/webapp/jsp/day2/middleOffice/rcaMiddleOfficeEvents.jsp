...
<script src="<%=servletContextUrl%>/js/day2/rcaMiddleOfficeEvents.js" type="text/javascript"></script>
<%String lastLeg = (String) request.getAttribute("proceedtoNextLeg");%>
<script type="text/javascript">

//show next leg navigation if its not last leg
...
$(document).ready(function() {
	...
	<div id="validationFlag" class="alert fade in alert-danger hide">
	...
	<form id="legSummary"  action="${context}/middleOffice/middleOfficeInputLeg.do" method="post"   enctype="multipart/form-data">
		...
		<c:if test="${param.eventType eq 11}">
			...
			<jsp:include page="../../common/inc/qualitativeAssessment_LegSummary.jsp">
				<jsp:param name="factors" value="Operational Risk - Ongoing"/>
			...
			<div class="span12 btn-container" style="margin-left:-10px!important;">
				<c:if test="${sessionScope.section eq 'myTasks'}">
					<div class="span3 right" style="background-color: #D9EDF7;   border:1px solid #A6C2D6;padding:5px;">
						...
						<input type="button" value="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Submit&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" class="btn btn-success btn-large" onclick="javascript:saveMiddleOffice(this);">
					</div>
					<c:choose>
						<c:when test="${requestScope.proceedtoNextLeg ne 'yes'}">
							...
							<a href="#cancelpopup" class="btn-link right cancel modal-confirm" data-toggle="modal" style="margin-top:95px">Cancel</a>
						</c:when>
						<c:otherwise>
							<a id="saveLeg1" class="btn right save-btn single" onclick="javascript:saveBut(this);" style="margin-top: 60px;">Save</a>
							<a href="#cancelpopup" class="btn-link right cancel modal-confirm" data-toggle="modal" style="margin-top:70px">Cancel</a>
						</c:otherwise>
					</c:choose>
				</c:if>
      ...
      <div class="modal hide fade" id="cancelpopup">
		<div class="modal-header">
			<a class="close" href="javascript:closeCancelModal()">X</a>
			<h3>Cancel Leg</h3>
		</div>
		...
		<div class="modal-footer">
			<a href="${context}/middleOffice/middleOffice.do?command=load&DealRequestID=${sessionScope.deal.dealSeqId}" class="btn right btn-success">Yes, cancel the Leg</a>
			<a class="btn-link right cancel" href="javascript:closeCancelModal()">No, take me back to the Leg</a>
		</div>
      </div>
</form>
