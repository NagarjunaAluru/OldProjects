...
<h2 class="span12">Original <span class="conditional-lender"></span></h2>
			<div id="0riginalLenderEditDetails" class="row">
				<div class="span12">
				 <table class="table table-striped table-bordered sortable">
					...
					<tbody>
						<tr>
							...
							<a class="edit-leg ttip" href="javascript:;" data-original-title="Edit this leg" id="lenderEdit"></a>
						...
						<tr>
                        	<td>&nbsp;</td>
							<td width="45%"><p><b>Legal Entity Name</b> <br> <logic:empty name="ICFPLegRequestForm" property="legSummary.lenderEntity.LEName">
										<p>-</p>
									</logic:empty>
							...
							<td><p><b>Country</b><br /> <logic:empty  name="ICFPLegRequestForm" property="legSummary.lenderEntity.country">
										<p>-</p>
									</logic:empty>
						...
						<tr>
                        	<td>&nbsp;</td>
							<td width="45%"><p><b>Is <span class="conditional-lender"></span> a regulated Entity?</b> <br> <logic:empty name="ICFPLegRequestForm" property="legSummary.lenderEntity.regulatedEntityFlag">
										<p>-</p>
									</logic:empty>
							...
							<td><p><b>Is <span class="conditional-lender"></span> a principal Entity?</b><br /> <logic:empty name="ICFPLegRequestForm" property="legSummary.lenderEntity.princplEntityFlag">
										<p>-</p>
									</logic:empty>
						...
						<tr>
                        	<td>&nbsp;</td>
							<td width="45%"><p><b>Management Entity</b> <br> <logic:empty name="ICFPLegRequestForm" property="legSummary.lenderEntity.MEName">
										<p>-</p>
									</logic:empty>
									<logic:notEmpty name="ICFPLegRequestForm" property="legSummary.lenderEntity.MEName">
						...
						<tr>
							...
							<td><p><b>Business Segment</b> <br> <logic:empty name="ICFPLegRequestForm"
										...
										<logic:notEmpty name="ICFPLegRequestForm"
											property="legSummary.lenderEntity.businessSegment">
											<p><bean:write name="ICFPLegRequestForm" property="legSummary.lenderEntity.businessSegment" /></p>
						...
						<tr>
							...
							<td><p><b>Funding Company/Holding Company/Operating Company</b><br /> <logic:empty name="ICFPLegRequestForm"
											property="legSummary.lenderEntity.fundHoldOperation">
											<p>-</p>
										</logic:empty>
										<logic:notEmpty name="ICFPLegRequestForm"
											property="legSummary.lenderEntity.fundHoldOperation">
											<p><bean:write name="ICFPLegRequestForm" property="legSummary.lenderEntity.fundHoldOperation"/></p>
	...
	<div id="lenderEditDetails">
		  ...
		  <div class="row">
					...
					<div class="row">
						<div class="span search-container">
							<div class="form-row">
								...
								<label>Original <span class="conditional-lender"></span>
						...
						<div class="row">
							<div class="span5">
								<div class="form-row">
									...
									<html:hidden name="ICFPLegRequestForm" property="legSummary.lenderEntity.LEName" styleId="leName" styleClass="leName" />
								</div>
							</div><!-- end of block -->
							<div class="span5 right">
								<div class="form-row">
									...
									<html:hidden name="ICFPLegRequestForm" property="legSummary.lenderEntity.country" styleId="country" styleClass="country" />
								</div>
							</div><!-- end of block -->
						</div>
			...
			<div class="row">
				...
				<div class="form-row">
					...
					<span  class="help-block error" id="lenderTreasuryfailed" style="display:none;">Please enter Treasury Code </span>
					<input type="text" maxlength="20" id="lenderTreasuryCode" class="span2" data-provide="typeahead" style="text-transform:uppercase" data-source=""/>
					...
					<a id="clearLenderTreasury" class="btn-link clear-conditional-results" href="#" type="submit">
				...
				<div id="lenBusSegDiv" class="span5 right">
					<div class="form-row">
						...
						<div class="radio-container" id="lenBusSegConDiv">
							...
							<html:hidden name="ICFPLegRequestForm" property="legSummary.lenderEntity.businessSegment" styleClass="businessSegment" styleId="lenderbusinessSegment"/>
						</div>
					</div>
				</div> <!-- end of block -->
			</div>
			<div class="row highlighted conditional-row" id="lenderTreasuryDetails">
				<div class="span5">
					<div class="form-row tcode">
						...
						<p><bean:write name="ICFPLegRequestForm" property="legSummary.lenderTCodeEntity.treasuryCode" /></p>
						<html:hidden name="ICFPLegRequestForm" property="legSummary.lenderTCodeEntity.treasuryCode" styleId="lenderTreasuryCodeId"/>
					</div>
				</div><!-- end of block -->
			</div>
    	...
    	<div class="span12 btn-container" style="margin-left:-10px!important;">
		   <a href="#" class="btn right btn-success" id="saveOriginalLenderDetails">Save Selection</a>
		   <a class="btn-link right clear-conditional-results" id="orgLenderClear" href="#" type="submit" onclick="javascript:clearLenderDetails();"><bean:message key="label.addLeg.clearResults" /></a>
			                  
		</div>
     </div>
		<h2 class="span12">Original <span class="conditional-borrower"></span></h2>
			<div  id="0riginalBorrowerEditDetails" class="row">
				<div class="span12">
				 <table class="table table-striped table-bordered sortable">
					<thead>
					  <tr>
					...
					<tbody>
						<tr>
							<td><a class="edit-leg ttip" href="javascript:;" data-original-title="Edit this leg" id="borrowerEdit"></a></td>
							<td  width="45%"><p><b>CDR Code</b> <br> <logic:empty name="ICFPLegRequestForm" property="legSummary.borrowerEntity.CDRCd">
										<p>-</p>
									</logic:empty>
							...
							<td><p><b>Legal Entity Gold Id</b><br /> <logic:empty name="ICFPLegRequestForm" property="legSummary.borrowerEntity.LEGoldId">
										<p>-</p>
									</logic:empty>
						...
						<tr>
                        	<td>&nbsp;</td>
							<td  width="45%"><p><b>Legal Entity Name</b> <br> <logic:empty  name="ICFPLegRequestForm" property="legSummary.borrowerEntity.LEName" >
										<p>-</p>
									</logic:empty>
							...
							<td><p><b>Country</b><br /> <logic:empty name="ICFPLegRequestForm" property="legSummary.borrowerEntity.country">
										<p>-</p>
									</logic:empty>
						...
						<tr>
                        	<td>&nbsp;</td>
							<td  width="45%"><p><b>Is <span class="conditional-borrower"></span> a regulated Entity?</b> <br> <logic:empty name="ICFPLegRequestForm" property="legSummary.borrowerEntity.regulatedEntityFlag" >
										<p>-</p>
									</logic:empty>
							...
							<td><p><b>Is <span class="conditional-borrower"></span> a principal Entity?</b><br /> <logic:empty name="ICFPLegRequestForm" property="legSummary.borrowerEntity.princplEntityFlag">
										<p>-</p>
									</logic:empty>
						...
						<tr>
                        	<td>&nbsp;</td>
							<td  width="45%"><p><b>Management Entity</b> <br> <logic:empty name="ICFPLegRequestForm" property="legSummary.borrowerEntity.MEName">
										<p>-</p>
									</logic:empty>
									<logic:notEmpty name="ICFPLegRequestForm" property="legSummary.borrowerEntity.MEName">
										<p><bean:write name="ICFPLegRequestForm" property="legSummary.borrowerEntity.MEName" /></p>
									</logic:notEmpty></p></td>
							<td><p><b>Capital or Industrial</b><br /> <logic:empty name="ICFPLegRequestForm" property="legSummary.borrowerEntity.capitalIndustrial" >
								<p >-</p>
							</logic:empty>
						...
						<tr>
							...
							<td><p><b>Business Segment</b> <br> <logic:empty name="ICFPLegRequestForm"
										...
										<logic:notEmpty name="ICFPLegRequestForm"
											property="legSummary.borrowerEntity.businessSegment">
											<p><bean:write name="ICFPLegRequestForm" property="legSummary.borrowerEntity.businessSegment" /></p>
						...
						<tr>
							...
							<td  width="45%"></td>
							<td><p><b>Funding Company/Holding Company/Operating Company</b><br /> <logic:empty name="ICFPLegRequestForm"
											property="legSummary.borrowerEntity.fundHoldOperation">
											<p>-</p>
										</logic:empty>
										<logic:notEmpty name="ICFPLegRequestForm"
											property="legSummary.borrowerEntity.fundHoldOperation">
											<p><bean:write name="ICFPLegRequestForm" property="legSummary.borrowerEntity.fundHoldOperation"/></p>
    ...
    <div id="borrowerEditDetails">         
       <div class="clear"></div>
	      ...
	      <div class="span12">        
			  ...
			  <div id="2b" class="tab-pane fade active in">
					<div class="row">
						<div class="span search-container">
							<div class="form-row">
								<span class="required">*</span>
								<label>Original <span class="conditional-borrower"></span>
									<span class="ttip info" data-original-title="<bean:message key="label.tooltip.lenderProvider" />"></span>
								</label>
								...
								<a href="#1a" class="btn entity-lookup" data-cmd="getLE" type="submit" id="searchByBorrowerGoldId">Search</a>
								<label class="checkbox info-checkbox pending">
						...
						<div class="row">
							<div class="span5">
								<div class="form-row">
									...
									<html:hidden name="ICFPLegRequestForm" property="legSummary.borrowerEntity.LEName" styleClass="leName" styleId="boleName" />
								</div>
							</div><!-- end of block -->
							<div class="span5 right">
								<div class="form-row">
									...
									<html:hidden name="ICFPLegRequestForm" property="legSummary.borrowerEntity.country" styleClass="country" styleId="borcountry" />
								</div>
							</div><!-- end of block -->
						</div>
			...
			<div class="span5">
					<div class="form-row">
						...
						<input type="text" class="span2" data-provide="typeahead"  id="borrowerTreasuryCode" style="text-transform:uppercase"/>
				...
				<div id="borBusSegDiv" class="span5 right">
					<div class="form-row">
						...
						<div class="radio-container" id="borBusSegConDiv">
							...
							<html:hidden name="ICFPLegRequestForm" property="legSummary.borrowerEntity.businessSegment" styleClass="businessSegment" styleId="borrowerbusinessSegment" />
						</div>
					</div>
				</div> <!-- end of block -->
			</div>
			<div class="row highlighted conditional-row" id="borrowerTreasuryDetails">
				<div class="span5">
					<div class="form-row tcode">
						<p><b><bean:message key="label.addLeg.treasuryCode" /></b></p>
						<p><bean:write name="ICFPLegRequestForm" property="legSummary.borrowerTCodeEntity.treasuryCode" /></p>
						<html:hidden name="ICFPLegRequestForm" property="legSummary.borrowerTCodeEntity.treasuryCode" styleId="borrowerTreasuryCodeId" />
					</div>
				</div><!-- end of block -->
			</div>
			...
			<div class="row">
				...
				<div class="span5 right">
					<div class="form-row">
						<label>Fund Co./Hold Co./Op Co.</label>
		...
		<div class="span12 btn-container" style="margin-left:-10px!important;">
		   <a href="#" class="btn right btn-success" id="saveOriginalBorrowerDetails">Save Selection</a>
		   <a class="btn-link right clear-conditional-results" id="orgBorrowerClear" href="#" type="submit"onclick="javascript:clearBorrowerDetails();"><bean:message key="label.addLeg.clearResults" /></a>
			                 
		</div>
        
	</div><!-- borrowerEditDetails ends here -->
