			...
			<div class="row">
					<div class="span5">
						<div class="form-row">
							...
							<html:text name="ICFPLegRequestForm"   property="dayTwoOperations.agreementExtension.amendmentMaturityDt"  styleId="amendmentMaturityDt" styleClass="span3 requestdatepicker-field" maxlength="10"   />
				...
				<div class="row">
					<div class="span5">
						<div class="form-row">
							...
							<html:text name="ICFPLegRequestForm" property="legSummary.maturityDt" styleClass="span3 requestdatepicker-field" styleId="maturityDt" maxlength="10"/>
...
<!--         <div class="span8 right btn-container">
		 <input type="button" value="Save and return to Deal" class="btn right btn-success" onclick="javascript:validateFOAgreementExtension(this);">
		...
		<!-- ------------- -->
			<div class="span12 btn-container" style="margin-left:-10px!important;">
				...
				<div class="span3 right" style="background-color: #D9EDF7;   border:1px solid #A6C2D6;padding:5px;">
					...
					<input type="button" class="btn btn-success btn-large" onclick="javascript:validateFOAgreementExtension(this);"
					value="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Submit&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" />
