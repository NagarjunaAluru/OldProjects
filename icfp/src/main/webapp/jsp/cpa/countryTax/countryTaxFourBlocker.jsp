...
<script src="${pageContext.request.contextPath}/js/countrytax.js" type="text/javascript"></script>
...
<body>
	<div class="container main">
		...
		<ul class="breadcrumb">
			...
			<li class="active">Regulatory/Jurisdictional Reviews</li>
		</ul>
		...
		<html:form action="/countryTax/countryTax.do" styleId="cashManagementFBId" method="POST" enctype="multipart/form-data">
		<h1 class="page-title span12">Regulatory/Jurisdictional Reviews</h1>
		<p class="span12 left clear dashdesc">View this transaction's
			summary below to accept or send back to the requester with your
			comments.
		...
		<jsp:include page="../../common/inc/progreessBar.jsp">
			...
			<jsp:include page="../../common/inc/commentsLog.jsp">
				...
				<jsp:param value="countryTax/countryTax" name="path"/>
				<jsp:param value="Regulatory/Jurisdictional Reviews" name="name"/>
