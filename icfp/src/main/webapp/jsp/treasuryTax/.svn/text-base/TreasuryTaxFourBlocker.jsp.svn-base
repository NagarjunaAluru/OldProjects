...
<script src="${pageContext.request.contextPath}/js/treasurytax.js" type="text/javascript"></script>
  ...
  <body>
	<div class="container main">
		...
		<ul class="breadcrumb">
			...
			<li class="active">Treasury Tax</li>
		</ul>
		...
		<h1 class="page-title span12">Treasury Tax</h1>
		...
		<form id="updateStatusForm" name="updateStatusForm" action="${context}/treasuryTax/treasuryTax.do" method="post" enctype="multipart/form-data">
		...
		<%@ include file="../../jsp/common/inc/transactionPriorityAndTiming.jsp"%>
		...
		<div class="form-mod">			
			<jsp:include page="../common/inc/commentsLog.jsp">
				...
				<jsp:param value="treasuryTax/treasuryTax" name="path"/>
			    <jsp:param value="Treasury Tax" name="name"/>	
			...
			<div class="span3 right submit-box">
				<div class="form-row">
					<div class="radio-container">
						<c:if test="${sessionScope.section eq 'myTasks'}">
							<label class="radio">
								<input type="radio" name="submitDealFB" value="affirm">
								Inputs Completed
							</label>
							<label class="radio">
								<input type="radio" name="submitDealFB" value="sendBack">
								Send back
							</label>
				...
				<div id="actionButton">
				<a href="#" id="submit" class="btn btn-success btn-large" style="width: 190px;">Submit</a>
				</div>
			</div>
			<c:if test="${sessionScope.section eq 'myTasks'}">
		...
		<input type="hidden" name="command" value="submitDealRequest"/>
		</div> 
		</form>
    <hr>
    </div>
