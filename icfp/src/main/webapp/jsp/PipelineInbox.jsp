...
<body>
	...
	<div class="container main">
		...
		<ul class="breadcrumb">
			...
			<li class="active"><bean:message key="heading.pipelineInbox.pageTitle"/></li>
		</ul>
		...
		<h1 class="page-title span12"><bean:message key="heading.pipelineInbox.pageTitle"/>
			...
			<select class="span2 chart-select" style="float: right; margin-left: 10px;">
		...
		<div class="form-mod">
			...
			<div class="row">
				<div class="span6">
					...
					<html:select name="pipelineInboxForm" property="dealCategory" styleClass="width: 100px;" styleId="dealCategoryID" size="5" multiple="true">
					<html:option value="">Select...</html:option>
				...
				<div class="span6 right">
					<div class="form-row">
					<p><b>Priority</b><br>
					<html:select name="pipelineInboxForm" property="priority" styleClass="width: 100px;" styleId="priorityID" size="5" multiple="true">
						<html:option value="">Select...</html:option>
			...
			<div class="row">
				<div class="span6">
					<div class="form-row">
					<p><b>Currency</b><br>
					<html:select name="pipelineInboxForm" property="currency" styleClass="width: 100px;" styleId="dealCategoryID" size="5" multiple="true">	
					<html:option value="">Select...</html:option>
			...
			<div class="row">
				...
				<!-- <input type="reset" class="btn-link right cancel" value="Clear Form" id="clearForm"/> -->                 
				</div>
			</div>
		</div>
		<div class="form-mod">
		...
		<div class="span12 pipeline-management-tables" style="margin-top: 30px;">
			...
			<div>
			<table class="table table-striped table-bordered sortable active paginate" 
					data-toggle="Show/Hide Chart" id="pipeline" >
				<thead>
					<tr>
						<th rowspan="2">#</th>
				...
				<tbody>
					...
					<logic:iterate id="dealRequest" name="pipelineDetailList" scope="session" indexId="counter">
						<tr>
							...
							<a href="javascript:void(0);" onclick="javascript:openTransaction(${dealRequest.requestID},'FOPipeline');">${dealRequest.uniqueId}</a>
							</div></td>
							<td style="word-wrap:break-word;"><div style="width:120px;overflow:auto">${dealRequest.dealName}</div></td>
							<td>${dealRequest.debtValue} </td>
							<td>${dealRequest.equityValue} </td>
							<td>${dealRequest.productTypeCollection}</td>
			...
			<table class="table table-striped table-bordered sortable layer active flyout paginate" data-toggle="Show below" id="pipeline1">
				<thead>
					<tr>
						<th rowspan="2">#</th>
						<th rowspan="2">Request Date</th>
				...
				<tbody>
					...
					<tr>
						<td>${ counter + 1 }</td>
						<td>${dealRequest.requestDate}</td>
						<td><div style="width:60px;overflow:auto"><a href="javascript:void(0);" onclick="javascript:openTransaction(${dealRequest.requestID},'FOPipeline');">${dealRequest.uniqueId}</a></div></td>
						<td style="word-wrap:break-word;"><div style="width:120px;overflow:auto">${dealRequest.dealName}</div></td>
			...
			<table class="table table-striped table-bordered sortable flyout active paginate"
			 data-toggle="Show to side" id="pipeline2">
				<thead>
					<tr>
						<th rowspan="2">#</th>
						<th rowspan="2">Request Date</th>
