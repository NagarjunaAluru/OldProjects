...
<script type="text/javascript" src="${context}/js/cashManagement/cashManagmentInput.js"></script>

<%String lastLeg = (String) request.getAttribute("proceedtoNextLeg");%>

<script type="text/javascript"> 
$(document).ready(function() {
//Flag to check wheather to show next leg navigation
		...
		<form id="legSummary"  action="${context}/cashManagement/cashManagementLeg.do" method="post"   enctype="multipart/form-data">
			...
			<div class="span12 btn-container" style="margin-left:-10px!important;">
				...
				<div class="span3 right" style="background-color: #D9EDF7;   border:1px solid #A6C2D6;padding:5px;">
					...
					<input type="button" class="btn btn-success btn-large" onclick="javascript:saveCashMgmt(this);"
					value="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Submit&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" />
