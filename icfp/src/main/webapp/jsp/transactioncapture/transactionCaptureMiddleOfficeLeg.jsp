...
var legLen = '<%=legLenforJS%>';
	...
	<script src="<%=servletContextUrl%>/js/transactionCaptureMiddleOfficeLeg.js" type="text/javascript"></script>
  ...
  <body>
	<div class="container main">
		...
		<p class="span12 left clear dashdesc"><%-- <bean:message key="label.leg.transactionCapture" /> --%>
		...
		<c:otherwise>
			...
			<%@ include file="../common/inc/solvencyMetricsView.jsp"%>
		</c:otherwise>
		</c:choose>
		...
		<div class="form-mod">
			...
			<div class="row">
				<div class="span5">
					...
					<label><bean:message key="label.leg1.transactionCapturedIn" /></label>
						...
						<!-- <a class="btn" style="margin-top: -10px;">Go</a> -->
					</div>
				</div> <!-- end of block -->
			</div>
			...
			<div class="row">
				<div class="span5">
					<div class="form-row">
						<span class="required">*</span>
						<label><bean:message key="label.leg1.transactionidloanmodelid" /><span class="ttip info" data-original-title="<bean:message key="label.tooltip.tradeLoanmodelIDs" />"></span></label>
						<html:text property="transactionId" maxlength="50" tabindex="1" styleClass="span3"
						 styleId="transactionId" value="${legSummaryVO.transactionId}" style="text-transform:uppercase"/>
					</div>
				</div>
			</div>
		...
		<c:otherwise>
		<div class="form-mod">
			<h2 class="span12">${sessionScope.deal.uniqueId} - ${legSummaryVO.legSeqId}</h2>
			<div class="row">
				<div class="span5">
					<div class="form-row">
					<span class="required">*</span>
			...
			<div class="row">
				<div class="span5">
					<div class="form-row">
						<span class="required">*</span>
						<label><bean:message key="label.leg1.inhouseloanmodelid" /><span class="ttip info" data-original-title="<bean:message key="tooltip.loanModelId.TCMOLeg" />"></span>
					    </label>
						<html:text property="transactionId" maxlength="50" tabindex="1" styleClass="span3" styleId="transactionId" value="${legSummaryVO.subLedgerTransactionId}" style="text-transform:uppercase"/>
					</div>
				</div>
			</div>
		</div>
