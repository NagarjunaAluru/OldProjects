...
<html lang="en">
 ...
 var contextURL = '<%=servletContextUrl%>';
	...
	<script src="${pageContext.request.contextPath}/js/middleoffice.js" type="text/javascript"></script>
  ...
  <body>
	<div class="container main">
		...
		<ul class="breadcrumb">
			...
			<li class="active">Middle Office</li>
		</ul>
		...
		<h1 class="page-title span12">Middle Office</h1>
	 ...
	 <html:form action="/middleOffice/middleOffice.do" styleId="cashManagementFBId" method="post"   enctype="multipart/form-data">
		...
		<div class="form-mod">
			<jsp:include page="../common/inc/commentsLog.jsp">
				...
				<jsp:param value="middleOffice/middleOffice" name="path"/>
				<jsp:param value="Middle Office" name="name"/>
