...
<title><bean:message key="label.fourBlocker.title" /></title>
...
$(document).ready(function() {
	...
	<script src="<%=servletContextUrl%>/js/middleOfficeInput.js" type="text/javascript"></script>
		...
		<form id="legSummary" action="${context}/middleOffice/middleOfficeInputLeg.do" method="post"   enctype="multipart/form-data">
			...
			<div class="span12 btn-container" style="margin-left:-10px!important;">
				...
				<div class="span3 right" style="background-color: #D9EDF7;   border:1px solid #A6C2D6;padding:5px;">
					...
					<input type="button" class="btn btn-success btn-large" onclick="javascript:saveMiddleOffice(this);"
					value="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Submit&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" />
