...
<html lang="en">
  <head>
    ...
    <title>ICF | Business Approver Approval</title>
...
var legLen = '<%=legLenforJS%>';
  ...
  <script src="<%=servletContextUrl%>/js/equityBusinessApproverFB.js" type="text/javascript"></script>	
  ...
  <body>
	<div class="container main">
		...
		<ul class="breadcrumb">
			...
			<li class="active">Business Approver Approval</li>
		</ul>
		...
		<h1 class="page-title span12">Business Approver Approval</h1>
	 ...
	 <html:form action="/equityBusinessApprover.do" styleId="cashManagementFBId" method="post"   enctype="multipart/form-data">
		...
		<jsp:include page="../common/inc/transactionLegs.jsp">
			<jsp:param value="equityBusinessApprover" name="path"/>
		</jsp:include>
		...
		<div class="form-mod">
			<jsp:include page="../common/inc/commentsLog.jsp">
				...
				<jsp:param value="equityBusinessApprover" name="path"/>
			    <jsp:param value="Business Approver Approval" name="name"/>
			...
			<div class="row comment-container">
					<div class="span5">
						<div class="form-row autosize-container">
							...
							<textarea class="xlarge autosize messageinput" name="dealComments"	onblur="scriptInjection(this);" rows="4" id="dealCommentsId">${sessionScope.deal.comments}</textarea>
						</div>
					</div>
					<!-- end of block -->
			</div>
