...
<c:set var="transferPricingInfo" 
	value="${deal:getTransferPricing(requestScope.legNumber, pageContext.request)}" />
			...
			<table class="table1 table-striped1 table-bordered1 sortable no-bottom table-nested">
				...
				<tbody>
					...
					<tr>
						...
						<td id="solvencyMetrics6TdID">${deal:getSolvencyMetricsAssessment(requestScope.legNumber, pageContext.request)[6]}
