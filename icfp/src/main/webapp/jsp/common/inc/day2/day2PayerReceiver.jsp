...
<fmt:setLocale value="en-US"/>
    ...
    <h2 class="span12">Receiver</h2>
		...
		<div class="form-mod entitylookup">
					...
					<div class="row">
						<div class="span search-container">
							<div class="form-row">
								...
								<span  class="help-block error duplicate" id="lenderDiffFailed" style="display:none;">Receiver and Payer must be different</span>
						...
						<div class="row ">
							<div class="span5">
								...
								<div class="form-row"><p><b>
									<span class="condition-lenderReg required">*</span>Is Receiver a Regulated Entity?</b></p>

									<div id ="lenderRegDiv" class="radio-container regulatedEntityFlag">
										<label class="radio" style="font-weight:normal;">
										<html:radio name="ICFPLegRequestForm" property="legSummary.lenderEntity.regulatedEntityFlag" styleId="regulatedEntityFlag1" disabled="true" value="true"/>
										<bean:message key="label.addLeg.yes" />
										</label>
										<label class="radio"  style="font-weight:normal;">
										<html:radio name="ICFPLegRequestForm" property="legSummary.lenderEntity.regulatedEntityFlag" styleId="regulatedEntityFlag2" disabled="true" value="false"/>
							...
							<div class="span5 right">
								<div class="form-row">
									<p><b><span class="condition-lenderPrn required">*</span>Is Receiver a Principal Entity?</b></p>
									
									<div id ="lenderPriDiv" class="radio-container princplEntityFlag">
										<label class="radio" style="font-weight:normal;">
										<html:radio name="ICFPLegRequestForm" property="legSummary.lenderEntity.princplEntityFlag" styleId="princplEntityFlag1" disabled="true" value="true"/>
										<bean:message key="label.addLeg.yes" />
										</label>
										<label class="radio"  style="font-weight:normal;">
										<html:radio name="ICFPLegRequestForm" property="legSummary.lenderEntity.princplEntityFlag" styleId="princplEntityFlag2" disabled="true" value="false"/>
										<bean:message key="label.addLeg.no" />
										</label>
			...
			<div id="lenderTreasuryDetails" style="display:none;" class="row conditional-row">
		...
		<div class="form-mod entitylookup">
			<div id="1b" class="tab-pane fade active in">
					<div class="row">
						<div class="span search-container">
							<div class="form-row">
								...
								<span  class="help-block error duplicate" id="borrowerGoldIdInvalid" style="display:none;">Receiver and Payer must be different</span>
								...
								<a href="#1b" class="btn entity-lookup" data-cmd="getLE" type="submit">Search</a>
								<label class="checkbox info-checkbox pending">
					...
					<div id="borrowerGoldIdDetails" class="conditional-row">
						...
						<div class="row ">
							<div class="span5">
								<div class="form-row">
									<p><b><span class="condition-borrowerReg required">*</span>Is Payer a Regulated Entity?</b></p>

									<div id ="borrowerRegDiv" class="radio-container regulatedEntityFlag">
										<label class="radio" style="font-weight:normal;">
										<html:radio name="ICFPLegRequestForm" property="legSummary.borrowerEntity.regulatedEntityFlag" styleId="borRegulatedEntityFlag1" disabled="true" value="true"/>
										<bean:message key="label.addLeg.yes" />
										</label>
										<label class="radio"  style="font-weight:normal;">
										<html:radio name="ICFPLegRequestForm" property="legSummary.borrowerEntity.regulatedEntityFlag" styleId="borRegulatedEntityFlag2" disabled="true" value="false"/>
										<bean:message key="label.addLeg.no" />
										</label>
							...
							<div class="span5 right">
								<div class="form-row">
									<p><b><span class="condition-borrowerPrn required">*</span>Is Payer a Principal Entity?</b></p>
									
									<div id ="borrowerPriDiv" class="radio-container princplEntityFlag">
										<label class="radio" style="font-weight:normal;">
										<html:radio name="ICFPLegRequestForm" property="legSummary.borrowerEntity.princplEntityFlag" styleId="borPrincplEntityFlag1" disabled="true" value="true"/>
										<bean:message key="label.addLeg.yes" />
										</label>
										<label class="radio"  style="font-weight:normal;">
										<html:radio name="ICFPLegRequestForm" property="legSummary.borrowerEntity.princplEntityFlag" styleId="borPrincplEntityFlag2" disabled="true" value="false"/>
										<bean:message key="label.addLeg.no" />
										</label>
			...
			<div class="row">
			 ...
			 <div id="borrowerTreasuryDetails" style="display:none;" class="row conditional-row">
