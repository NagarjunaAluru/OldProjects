...
<script src="${pageContext.request.contextPath}/js/transferpricing.js" type="text/javascript"></script>
...
<body>
	<div class="container main">
		...
		<ul class="breadcrumb">
			...
			<li class="active">Transfer Pricing</li>
		</ul>
        ...
        <div id="validationsRequired" style="display:none;" class="alert fade in alert-danger hide">
         ...
         <logic:messagesPresent >
	         <div id="validationsRequired"  class="alert fade in alert-danger">
	            <a href="#" data-dismiss="alert" class="close">X</a>
	            <strong>Please fix the following fields highlighted in red.</strong> 
		...
		<html:form action="/transferPricing/transferPricing.do" styleId="cashManagementFBId" method="post" enctype="multipart/form-data">
		<h1 class="page-title span12">Transfer Pricing</h1>
		<c:if test="${sessionScope.section eq 'myTasks'}">
		<p class="span12 left clear dashdesc"><bean:message key="label.fourBlocker.transferPricing" />
		...
		<%@ include file="../common/inc/dealTeam.jsp"%>
			...
			<jsp:include page="../common/inc/commentsLog.jsp">
				...
				<jsp:param value="transferPricing/transferPricing" name="path"/>
				<jsp:param value="Transfer Pricing" name="name"/>
	...
	<!-- <div class="modal hide fade" id="assignReviewer">
		...
		<div class="modal-footer">
			<a href="#derivatives-table" class="btn right btn-success" data-dismiss="modal">Assign to team member</a>
			<a href="#" class="btn-link right cancel" data-dismiss="modal">Close window</a>
		</div>
	</div> -->
	<!-- Assign a Reviewer Popup -->
