...
<fmt:setLocale value="en-US"/>
 ...
 var contextURL = '<%=servletContextUrl%>';
	...
	<script src="<%=servletContextUrl%>/js/rcaDay1TransferPricing.js" type="text/javascript"></script>
...
//Defining the global variable, so this variable can be used by other javascript library included in this JSP 
 var contextURL = '<%=servletContextUrl%>';
				...
				*/
				 var nextLegNumberVar = '<%=nextLegNumber%>';
				  ...
				  $('#saveLeg').click(function(e){
					  var commitmentFeeApplicableFlagLocal = document.forms[0].elements("commitmentFeeApplicableFlag");
						if(commitmentFeeApplicableFlagLocal[0].checked==true) {
			  				if($('#commitmentFeeDiv').is(':visible')==false) {
			  					$('#commitmentFeeDiv').find('input[type=radio]:checked').removeAttr('checked');
			  				}  
		  				}
	...
	<html:form action="/transferPricing/transferPricingLeg.do"  styleId="ICFPLegRequestForm" method="post"  enctype="multipart/form-data">
			   ...
			   <div class="row">
			   	   <div class="span5">
						<div class="form-row">
							...
							<html:text name="ICFPLegRequestForm" styleClass="span1  spreadvalidate"   property="rateInformation.minSpread"  styleId="floatMinSpreadBPSID"  maxlength="10"   />
							<span class="req-error" style="display:none;">error</span>
						</div>
		...
		<div class="form-mod">
		 ...
		 <jsp:include page="../common/inc/auditLog.jsp">
			...
			<div class="span3 right submit-box">
			 ...
			 <a style="margin-top:75px" class="btn-link right cancel modal-confirm" href="#confirm" data-toggle="modal">Cancel</a>
