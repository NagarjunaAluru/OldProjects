	...
	<div class="container main">
		...
		<ul class="breadcrumb">
			...
			<logic:equal scope="session" name="addOrModifyFlag" value="modify">
     			<li><a href="<%=servletContextUrl%>/frontoffice/RCALegRequest/derivativeRequest.do?command=redirectAddLeg&legNumber=<bean:write name="derivativesRequestForm" property="legNumber" />&derivativeNumber=<bean:write name="derivativesRequestForm" property="derivativeNumber" />">Modify a Leg</a> <span class="divider">/</span></li>
			</logic:equal>
			<logic:notEqual scope="session" name="addOrModifyFlag" value="modify">
				<li><a href="<%=servletContextUrl%>/frontoffice/RCALegRequest/derivativeRequest.do?command=redirectAddLeg&legNumber=<bean:write name="derivativesRequestForm" property="legNumber" />&derivativeNumber=<bean:write name="derivativesRequestForm" property="derivativeNumber" />">Add a Leg</a> <span class="divider">/</span></li>
			</logic:notEqual>
        ...
        <logic:notEqual scope="session" name="addOrModifyDerivative" value="modify">
    		...
    		<h1 class="page-title span10">Add Front office Derivative</h1>
		</logic:notEqual>
		<logic:equal scope="session" name="addOrModifyDerivative" value="modify">
		...
		<html:form action="/frontoffice/RCALegRequest/derivativeRequest.do"  styleId="fundingRequestForm" method="post"   enctype="multipart/form-data">
		<div class="form-mod">
					...
					<div class="span15 right">
						<div class="form-row">
							...
							<label>Hedge Desigation - U.S. GAAP</label>
							 <html:select name="derivativesRequestForm" tabindex="12" styleId="hedgeDesigationId" property="hedgeDesignationId"  styleClass="span2 hedgeDesignation-select">
					...
					<div class="span15 right contractClass">
						<div class="form-row">
							...
							<label>Contract Class</label>
							 <html:select name="derivativesRequestForm" tabindex="17" property="contractClassId" styleId="contractClassId" styleClass="span2">
								<html:option value="">Select</html:option>
					...
					<div class="span15 right hedgeProgram">
						<div class="form-row">
							...
							<label>Hedge Program</label>
							 <html:select name="derivativesRequestForm" tabindex="14" property="hedgeProgramId" styleId="hedgeProgramId" styleClass="span2">
								<html:option value="">Select</html:option>
					...
					<div class="row">
						<div class="span search-container">
							<div class="form-row">
								...
								<a href="#1" class="btn entity-lookup" type="submit"   onclick="getCounterPartyDetails('counterParty1')">Search</a>
							</div>
							<div class="form-row">
							...
							<div class="span5">
									<div class="form-row">
										...
										<input type="text" maxlength="20" name="counterPrty[0].entity.MEName" class="span2"  id="selectedLenderMgmtEntity" style="text-transform:uppercase"/>
				 						...
				 						<input type="button" name="Search"  value="Search" onclick="getManagementEntity('counterParty1')" />
									</div>
							</div> <!-- end of block -->
						</div>
					<div class="row highlighted" id="showDivMEDetailsID" style="display:none" >
					<div class="span5">
						<div class="form-row">
						  <p> <bean:write name="derivativesRequestForm" property="counterPartyInfos[0].entity.MEName" /></p>
							<input type="hidden" name="counterPartyInfos[0].entity.MEName" id="meName1" value="<bean:write name="derivativesRequestForm" property="counterPartyInfos[0].entity.MEName" />" />
						</div>
					</div>
				</div>	
			...
			<h2>Counterparty 2 </h2>
					...
					<div class="row">
						<div class="span search-container">
							<div class="form-row">
								...
								<a href="#1a" class="btn entity-lookup" onclick="getCounterPartyDetails('counterParty2')"  type="submit">Search</a>
							...
							<label class="checkbox info-checkbox pending">
								...
								<a class="btn-link right clear-conditional-results" href="#" type="submit"onclick="javascript:clearBorrowerDetails();"><bean:message key="label.addLeg.clearResults" /></a>
							</div>
						</div> <!-- end of block -->
					</div> 
				<!-- 	<div id="borrowerGoldIdDetails" class="conditional-row"> -->
					<div id="borrowerGoldIdDetails" class="conditional-row" >
						...
						<div class="row highlighted">
							<div class="span5">
								<div class="form-row">
									...
									<html:hidden name="derivativesRequestForm" property="counterPartyInfos[1].entity.LEName" styleClass="leName"/>
								</div>
							</div><!-- end of block -->
						</div>
						<div class="row">
						...
						<html:hidden name="derivativesRequestForm" property="counterPartyInfos[1].entity.leTypeId"  value="2" />
						</div>
						<div class="row">	
							<div class="span5">
									<div class="form-row">
										...
										<label><bean:message key="label.addLeg.managementEntity" /><span class="ttip info" data-original-title="<bean:message key="label.tooltip.managementEntity" />"></span></label>
										<span  class="help-block error" id="lenderMgmtfailed" style="display:none;">Please select Management Entity </span>
										<input type="text" maxlength="20" name="counterPrty[1].entity.MEName" class="span2"  id="selectedBorrowerMgmtEntity" style="text-transform:uppercase"/>
				 						<span id="lenderMgmtfailedBar" class="req-error" style="display:none;">error</span>
				 						<input type="button" name="Search"  value="Search" onclick="getManagementEntity('counterParty2')" />
									</div>
							</div> <!-- end of block -->
						</div>
						<div class="row highlighted" id="showDivMEDetailsID2"  style="display:none">
							<div class="span5">
								<div class="form-row">
				...
				<div class="row">
					...
					<h2>Currency 1</h2>
						<div class="form-row">
							...
							<span  class="help-block error" id="currency1IdInvalid" style="display:none;">Invalid value</span>
					...
					<h2>Currency 2</h2>
						<div class="form-row">
							<span class="required">*</span>
							<label>Currency </label>
							<span  class="help-block error" id="currency2IdInvalid" style="display:none;">Invalid value</span>
					...
					<div class="span15">
						<div class="form-row">
							...
							onchange="javascript:commaAmount1();" value="<fmt:formatNumber  value="${sessionScope.derivativesRequestForm.map.counterPartyInfos[0].amt}" />"/>
								<span id="derivativeAmount1IdErrorSpan" class="req-error" style="display:none;">error</span>
							</div>
						</div>
					</div> <!-- end of block -->
					<div class="span15 right">
						<div class="form-row">
							...
							onchange="javascript:commaAmount2();" value="<fmt:formatNumber  value="${sessionScope.derivativesRequestForm.map.counterPartyInfos[1].amt}" />"/>
								...
								<span id="derivativeAmount2IdErrorSpan" class="req-error" style="display:none;">error</span>
							</div>
						</div>
					</div> <!-- end of block -->
				</div>
							...
							<div class="radio-container conditional-radio-tri" id="FixOrFloat1Div">
								...
								<div  id="fixedRateDivID1"  >
									<div class="form-row">
											...
											<span id="fixedFixedRateId1ErrorSpan" class="req-error" style="display:none;">error</span>	
									</div>
								</div>
								<label class="radio">
					...
					<div class="span15">
						<div class="form-row">
							<div class="left">
								...
								<span id="spread1IdErrorSpan" class="req-error" style="display:none;">error</span>								
							</div>
						</div>
					</div> <!-- end of block -->
					<div class="span15 right">
						<div class="form-row">
							<div class="left">
								...
								<span id="spread2IdErrorSpan" class="req-error" style="display:none;">error</span>								
							</div>
						</div>
					</div> <!-- end of block -->
				</div>
...
<div class="form-mod attachments-mod">
	<h2 class="span12 collapsible">Attachments</h2>
        ...
        <div class="span8 right btn-container">
			...
			<input type="button" value="Save and add new Derivative" class="btn right" onclick="javascript:saveAndReturnDerivative();" tabindex="33">
			<a href="<%=servletContextUrl%>/frontoffice/RCALegRequest/derivativeRequest.do?command=cancelDerivative" class="btn-link right cancel" tabindex="34">Cancel</a>
