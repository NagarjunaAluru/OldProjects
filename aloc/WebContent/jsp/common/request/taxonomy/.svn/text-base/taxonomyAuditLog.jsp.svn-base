...
<div class="form-mod" id="auditLogDiv">
		  <div class="row">
			  <div class="span12">
			        <table class="table table-striped table-bordered sortable no-bottom paginate" id="treasuryAuditlogTable">
					    <thead>
							  <tr id="column_head">
								...
								<td><s:text name="label.request.auditLog.tableHeader.2"/><span class="ttip info" data-original-title="<s:text name="label.request.auditLog.tooltip.completionDate"/>"></span></td>
								<td><s:text name="label.request.auditLog.tableHeader.3"/></td>
				  ...
				  <tbody>		
	            	<s:if test="%{comBidReplies.auditLogs !=null}">
							<s:iterator value="comBidReplies.auditLogs" status="stat">
									<tr class="shown">
