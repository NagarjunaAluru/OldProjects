...
<s:set name="isEditMode" value="editMode"/>
	  ...
	  <s:if test="%{#isEditMode==true || ((requestDetails.WFDetails.WFStage == 'REQEST' || requestDetails.WFDetails.WFStage == 'REQUEST' && #attr.isTaxonomy != true)  && requestDetails.buContactPerson.requiresEdits)}">
	  <s:if test="%{(requestDetails.WFDetails.WFStage == 'REQEST' || requestDetails.WFDetails.WFStage == 'REQUEST') && requestDetails.buContactPerson.requiresEdits}">
						<div class="row">
							<div class="span12">
								<div class="errorbox">
									<div class="noteHead">
		...
		<div class="row">
			<div class="span12">
				<div class="form-row">
					<s:select headerKey="" key="label.request.site"
						headerValue="Select..."
						list="%{#attr['com.ge.aloc.StaticDataFactory'].userSpecificSitesList}"
						listKey="ID" listValue="name" name="siteId" id="selectedSiteId"
			...
			<div class="span12">
				<div class="form-row" style="padding-top:5px;padding-left: 20px; margin-bottom: 0px;">
					...
					<input type="hidden" name="sectionName" class="sectionName" value="buContactPerson">
                       	...
                       	<tr>
                       		<td height="1" class="noPadding">
									...
									<div class="form-row">
										<div class="span4 left" style="width:240px;">
											<s:textfield name="businessContactPerson" 
												 ...
												 theme="aloc" cssClass="span3 lookup-filterValue bContactPersonName"
												 id="businessContactPersonId"/>
												 <s:hidden name="businessContactName1" value="BUC" cssClass="businessContactClass"></s:hidden>
								...
								<div class="${businessClass}" id="businessShow">
										<s:hidden name="businessContactPersonSelection" id="businessSelectionId" value="%{#requestornameSelected}"></s:hidden>
														...
														<div class="span5 left">
															<div class="form-row">
																...
																<s:hidden name="requestDetails.buContactPerson.buRequestors[0].name"
																	id="bcpName" cssClass="name mandatory"></s:hidden>
															</div>
														</div>
													</div>
													<div class="row smallrow">
														...
														<div class="span2 left">
															<div class="form-row">
																...
																<s:hidden name="requestDetails.buContactPerson.buRequestors[0].phoneNumber"
																	id="phoneNumber" cssClass="phone mandatory"></s:hidden>
															</div>
														</div>
													</div>
													<div class="row smallrow">
														...
														<div class="span2 left">
															<div class="form-row">
																...
																<s:hidden name="requestDetails.buContactPerson.buRequestors[0].emailAddr"
																	id="emailAddr" cssClass="email mandatory"></s:hidden>
						    ...
						    <div class="row">
									<div class="form-row">
										<div class="span4 left" style="width:240px;">
											...
											<s:textfield required="false" theme="aloc" cssClass="span3 lookup-filterValue bContactPersonName2 referenceTextValue" id="businessContactPersonId2"/>
											<s:hidden name="businessContactName2" value="BUC" cssClass="businessContactClass"></s:hidden>
						     ...
						     <div class="row">
									<div class="form-row">
										<div class="span4 left" style="width:240px;">
											...
											<s:textfield required="false" theme="aloc" cssClass="span3 lookup-filterValue bContactPersonName3 referenceTextValue" id="businessContactPersonId3"/>
											<s:hidden name="businessContactName3" value="BUC" cssClass="businessContactClass"></s:hidden>
											<p class="guidance"><s:text name="label.request.partialLastName" /></p>
											<span class="lookup-error hide" style="color: #AE2C2C;"></span>
										</div>	
										<div class="span2 left" style="width:240px;">
                       ...
                       style="display: ${bucontactRefIndex < 2 ? 'block' : 'none'}; margin-top: -10px;margin-left: -20px !important;"><s:text  name="label.request.addContactPerson"/></a>
					
				</div>
			</div><!-- end of block -->
		</div>
		<script type="text/javascript">
			refreshSectionCount('businessContactPersonPanel');
		</script>
		</s:if>
            ...
            <s:iterator value="requestDetails.buContactPerson.buRequestors" status="stat">	
				<div class="row">
	               <div class="span3b">
					...
					<div class="span5 left">
						<div class="form-row">
							<p class="padding40"><c:out value="${name}"/></p>
							<p class="padding40"><c:out value="${phoneNumber}"/></p>
							<p class="padding40"><c:out value="${emailAddr}"/></p>
						</div>
			        </div>
			    </div>	
		    </s:iterator>
