					...
					<div class="form-row">
						<div class="span4 left" style="width:240px;">
							...
							<s:textfield required="false" theme="aloc"
								cssClass="span3 lookup-filterValue referenceTextValue bContactPersonName2" id="businessContactPersonId2"/>
						...
						<div class="span2 left" style="width:240px;">
							<label>&nbsp;</label>
							<s:url action="BusinessContactPersonLookup" namespace="/int"
				...
				<div class="row">
					<div class="form-row">
						<div class="span4 left" style="width:240px;">
							...
							<s:textfield required="false" theme="aloc"
								cssClass="span3 lookup-filterValue referenceTextValue bContactPersonName3" id="businessContactPersonId3"/>
...
<script
	src="${pageContext.request.contextPath}/js/requestor/addBcpReference.js"
	type="text/javascript"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/js/requestor/buContactperson.js"></script>
