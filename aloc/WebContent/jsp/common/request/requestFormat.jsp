...
<div style="color: red;">	<!-- validation error occurs at edit level -->
	...
	<s:fielderror fieldName="requestDetailsBO.formatBO.attachmentBOList" /> 
</div>
<div class="row">
	<div class="span12">
		<div class="form-row">
									...
									<tr class="spantr2" id="attachment-added">										
									 <td colspan="2" class="spantd2">
														...
														<p style="align: left;">
															<c:if
																...
																<s:checkbox label="%{getText('label.attachment.surety')}"
																	...
																	<s:hidden name="requestDetailsBO.formatBO.attachmentBOList[%{#formatAtmtBOItrStatus.index}].suretyPermission" value="true"/>
															</c:if>
															<c:if test="${requestDetailsBO.model.instrumentTypeId eq '1' || requestDetailsBO.model.instrumentTypeId eq '2' || requestDetailsBO.model.instrumentTypeId eq '5' || requestDetailsBO.model.instrumentTypeId eq '4'}">
															...
															&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<s:checkbox
																label="%{getText('label.attachment.treasury')}" fieldValue="true" disabled="true"
																name="requestDetailsBO.formatBO.attachmentBOList[%{#formatAtmtBOItrStatus.index}].treasuryPermission"
																theme="aloc" value="true" />
																<s:hidden name="requestDetailsBO.formatBO.attachmentBOList[%{#formatAtmtBOItrStatus.index}].treasuryPermission" value="true"/>
														</p>
													</div>
												</c:when>
												<c:when
													...
													<div class="form-row">
														<p style="align: left;">															
															 <c:if test="${requestDetailsBO.model.instrumentTypeId eq '3'}">															
																<s:checkbox
																	label="%{getText('label.attachment.surety')}" fieldValue="true" value="true"
																	name="requestDetailsBO.formatBO.attachmentBOList[%{#formatAtmtBOItrStatus.index}].suretyPermission"
																	theme="aloc" disabled="true" cssClass="bankOrSuretyAtmtPermission" />
																<s:hidden name="requestDetailsBO.formatBO.attachmentBOList[%{#formatAtmtBOItrStatus.index}].suretyPermission" value="true"/>
															</c:if>
															<c:if test="${requestDetailsBO.model.instrumentTypeId eq '1' || requestDetailsBO.model.instrumentTypeId eq '2' || requestDetailsBO.model.instrumentTypeId eq '5' || requestDetailsBO.model.instrumentTypeId eq '4'}">
																<s:checkbox label="%{getText('label.attachment.bank')}" fieldValue="true" value="true"
																name="requestDetailsBO.formatBO.attachmentBOList[%{#formatAtmtBOItrStatus.index}].bankPermission"
																theme="aloc" disabled="true"/>
															<s:hidden name="requestDetailsBO.formatBO.attachmentBOList[%{#formatAtmtBOItrStatus.index}].bankPermission" value="true"/>
															</c:if>
																
															&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<s:checkbox
																label="%{getText('label.attachment.treasury')}" fieldValue="true" value="true" disabled="true"
																name="requestDetailsBO.formatBO.attachmentBOList[%{#formatAtmtBOItrStatus.index}].treasuryPermission"
																theme="aloc"/>
															<s:hidden name="requestDetailsBO.formatBO.attachmentBOList[%{#formatAtmtBOItrStatus.index}].treasuryPermission" value="true"/>	
														</p>
										...
										<div class="alocAttachmentContainer"> 
											<p>
												<input  type="file" class="alocFileupload" name="fileUpload" data-url="${pageContext.request.contextPath}/int/atmt/upload.action?typeId=1&formatId=3&index=0"/>												
											</p>									
									...
									<td colspan="2" class="spantd2">
										<div class="form-row">
											<p style="align: left;" >												
													<c:if test="${requestDetailsBO.model.instrumentTypeId eq '3'}">																								
														<s:checkbox label="%{getText('label.attachment.surety')}"
															theme="aloc" fieldValue="true" disabled="true" value="true"
															name="requestDetailsBO.formatBO.attachmentBOList[0].suretyPermission" cssClass="bankOrSuretyAtmtPermission"/>
														<s:hidden name="requestDetailsBO.formatBO.attachmentBOList[0].suretyPermission" value="true"/>
													</c:if>											
													<c:if test="${requestDetailsBO.model.instrumentTypeId eq '1' || requestDetailsBO.model.instrumentTypeId eq '2' || requestDetailsBO.model.instrumentTypeId eq '5' || requestDetailsBO.model.instrumentTypeId eq '4'}">
														<s:checkbox label="%{getText('label.attachment.bank')}" fieldValue="true"
														theme="aloc" disabled="true" value="true"
														name="requestDetailsBO.formatBO.attachmentBOList[0].bankPermission"/>
													<s:hidden name="requestDetailsBO.formatBO.attachmentBOList[0].bankPermission" value="true"/>
													</c:if>		
														
													&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;																							
													<s:checkbox label="%{getText('label.attachment.treasury')}"
														theme="aloc" disabled="true" value="true" fieldValue="true"
														name="requestDetailsBO.formatBO.attachmentBOList[0].treasuryPermission" />
													<s:hidden name="requestDetailsBO.formatBO.attachmentBOList[0].treasuryPermission" value="true"/>
											</p>
										</div>
									</td>
									<td>
