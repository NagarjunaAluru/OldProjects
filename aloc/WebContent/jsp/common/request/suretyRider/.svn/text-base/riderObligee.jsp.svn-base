...
<s:if test="%{#isEditMode==true}">
	...
	<c:if test="${param.includeScripts != false}">
		...
		<div class="row">
			<s:if test="%{obligeeAddressSelection == null}">
				<s:if
					test="%{requestDetails.rider == null || requestDetails.rider.obligee == null || 
		          requestDetails.rider.obligee.addressDtls == null || 
					...
					<s:set var="ObligeeNameSelected"
						value="%{obligeeAddressSelection}" />
				</s:if>
				<s:else>
			...
			<div class="span6">
				<div class="form-row">
					...
					<s:textfield name="nameForAddress"
						cssClass="span3 lookup-filterValue nameForObligeeAddress" id="obligeeNameAddressId" />
					...
					<a class="btn-secondary lookup"
						...
						style="display: none;height: 20px;"><br />
		...
		<div class="lastrow" id="ObligeeShow"
			style="${ObligeeDetailsClass}">
		...
		<div class="conditional-row-manually" id="ObligeeShowManually">
			<div class="row">
				<div class="span6">
					<div class="form-row">
						<s:textfield
							name="requestDetails.rider.obligee.addressDtls.name"
			...
			<div class="row">
				<div class="span6">
					<div class="form-row">
						<s:textfield
							name="requestDetails.rider.obligee.addressDtls.city"
				...
				<div class="span6">
					<div class="form-row">
						<sj:autocompleter id="obligeeAddressCountryCd"
							...
							parentTheme="aloc" onChangeTopics="getAutocompleterName" />
						<s:hidden
							name="requestDetails.rider.obligee.addressDtls.country"
							id="obligeeAddressCountry" cssClass="autoCompleterName"></s:hidden>
					</div>
				</div>
			</div>
			<div class="row">
						...
						<label class="checkbox">
							<s:checkbox name="requestDetails.rider.obligee.addressDtls.futureUseFlag" fieldValue="true"> </s:checkbox>
						</label>
	...
	<div class="row">
		...
		<div class="span2 left">
			<div class="form-row">
				<p><s:property value="requestDetails.previousRider.obligee.addressDtls.name" /></p>
				<s:iterator value="requestDetails.previousRider.obligee.addressDtls.address">
					<p><s:property /></p>
				</s:iterator>
				<p><s:property value="requestDetails.previousRider.obligee.addressDtls.city" />
				<s:property value="requestDetails.previousRider.obligee.addressDtls.stateProvince" />
				<s:property	value="requestDetails.previousRider.obligee.addressDtls.ZIPPostalCode" /></p>
				<p><s:property value="requestDetails.previousRider.obligee.addressDtls.country" /></p>
			</div>
		</div>
	</div>
	</c:if>
...
<s:elseif test="%{#isEditMode==false}">
	...
	<div class="row">
		...
		<div class="span2 left">
			<div class="form-row">
				<p><s:property value="requestDetails.rider.obligee.addressDtls.name" /></p>
				<s:iterator value="requestDetails.rider.obligee.addressDtls.address">
					<p><s:property /></p>
				</s:iterator>
				<p><s:property value="requestDetails.rider.obligee.addressDtls.city" />
				...
				<p><s:property value="requestDetails.rider.obligee.addressDtls.country" /></p>
				
				<s:hidden name="requestDetails.rider.obligee.addressDtls.address[0]" id="obligeeAddress1" />
				<s:hidden name="requestDetails.rider.obligee.addressDtls.address[1]" id="obligeeAddress2" />
				<s:hidden name="requestDetails.rider.obligee.addressDtls.city" id="obligeeAddressCity"/>
				<s:hidden name="requestDetails.rider.obligee.addressDtls.stateProvinceCd" id="obligeeAddressStateCd"/>
				<s:hidden name="requestDetails.rider.obligee.addressDtls.stateProvince" id="obligeeAddressState" />
				<s:hidden name="requestDetails.rider.obligee.addressDtls.ZIPPostalCode" id="obligeeAddressZip"/>
				<s:hidden name="requestDetails.rider.obligee.addressDtls.countryCd" id="obligeeAddressCountryCd"/>
				<s:hidden name="requestDetails.rider.obligee.addressDtls.country" id="obligeeAddressCountry" />
			</div>
		</div>
	</div>
	</c:if>
