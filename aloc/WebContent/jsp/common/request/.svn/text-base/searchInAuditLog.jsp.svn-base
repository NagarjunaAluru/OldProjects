...
<div class="row">
	           	  <s:form name="searchForm" id="searchActionForm" action="auditandActionSearch" namespace="/int/approver">
		              ...
		              <s:hidden name="taxonomyViewType" value="%{taxonomyViewType}" />
						...
						<s:url action="auditandActionSearch.action" var="actionSearchURL" namespace="/int/approver" encode="true" escapeAmp="false"/>
						 <div class="span1">
						    <label>&nbsp;</label>
...
<script src="${pageContext.request.contextPath}/js/requestor/auditLog.js" type="text/javascript"></script>
