...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
	  ...
	  <p><s:text name="label.request.transactionHistoryLog.sectionDescription" /> <s:property value="requestDetails.alocRecordId"/></p></h2><hr class="h2-hr">
	   <div class="clear"></div>
	         <div class="row">
	            <div class="span12">
                	 <s:url action="openRequest.action" var="openTaxonomyRequestURL" namespace="/int" escapeAmp="false" encode="true">
		   ...
		   <jsp:include page="/jsp/common/request/searchInActionLog.jsp"/><br/>
			<jsp:include page="/jsp/common/request/ActionLogSearchResult.jsp" />
