	...
	<h1 class="page-title span12"><s:text name="label.request.requestFullView" /></h1>
		...
		<div class="row">
			<div class="span12">
				...
				<s:url action="openFeePaymentRun.action" namespace="/int/apm" var="feePaymentRunURL" />
				<c:choose>
					...
					<div class="span12 whitebg">
						...
						<div class="span3 left">
							<div class="marginT">
								...
								<p>
									<s:if test="%{requestDetails.winningBankDetails.winnerDetails.winningBankName==null}">-</s:if>
