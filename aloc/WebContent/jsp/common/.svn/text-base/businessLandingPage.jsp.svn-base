...
<html lang="en">
  <head>
    ...
    <title><s:text name="label.request.landingPageBusiness" /></title>
							...
							<ul>
								<li>
									...
									<c:if test="${landingpageDetails.pendingMyApprovalNum gt 0}">
										<a href="<s:property value="#myTransactionDashboardURL" />"><s:text name="label.request.pendingApprovals" />
									...
									landingpageDetails.pendingMyApprovalNum eq 0}">
										<s:text name="label.request.pendingApprovals" />
										<fmt:formatNumber type="NUMBER" value="${landingpageDetails.pendingMyApprovalNum}" maxFractionDigits="0"/>
									</c:if>
								</li>
								<li>
									<s:url action="displayAllRequestDashboard.action" namespace="/int/dashboard" var="allRequestDashboardURL" />
									<hwfs:checkComponentPermission name="BusinessTrackInFlights" domainName="BusinessAccess">
									<c:if test="${landingpageDetails.trackInFlightRequestsNum gt 0}">
										<a href="<s:property value="#allRequestDashboardURL" />"><s:text name="label.request.trackInFlightRequests" /></a>
									</c:if>
						...
						<div class="boxHead"><s:text name="label.request.reporting" /></div>
							<div class="boxContent">
								...
								<%-- <div class="span4 right">
									...
									<p class="customContent"><label><s:text name="label.request.allowsForTheCreationOfUpToFive" /></label></p>
									<ul>
