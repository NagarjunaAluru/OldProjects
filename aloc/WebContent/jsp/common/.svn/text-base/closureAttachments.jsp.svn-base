...
<div class="row">
	<div class="span12">
			...
			<tbody>
				<s:if
					test="%{requestDetailsBO.attachmentBOList != null && requestDetailsBO.attachmentBOList.size>0}">
										...
										<p style="padding: 10px 0 0 10px;">
											<s:if test="%{model.geFileId !=null && model.geFileId !=0}"> 									
												<a href='javascript:void(0)'
													onclick="javascript:deleteAttachment('<s:property value="model.geFileId"/>',4,<s:property value="#atmtBOItrStatus.index"/>)">
								...
								<div class="alocAttachmentContainer">
									<p>
										<input type="file" class="alocFileupload" name="fileUpload"
											data-url="${pageContext.request.contextPath}/int/atmt/upload.action?typeId=4&index=<s:property value="%{#atmtBOItrStatus.index}"/>" />
									</p>
					...
					<tr>
						...
						<td>
							<div class="alocAttachmentContainer">
								<p>
									<input type="file" class="alocFileupload" name="fileUpload"
										data-url="${pageContext.request.contextPath}/int/atmt/upload.action?typeId=4&index=0" />
								</p>
...
<s:hidden id="closureTextAreaId" name="closureTextAreaId" value=""/>
