...
<link href="${pageContext.request.contextPath}/ext/public/css/others/help.css" rel="stylesheet">
</head>
<body>
	<div class="container main">
		...
		<div class="form-mod">
			<h2 id="fees" class="section_flip section_noToggle"><a href="javascript:;"><s:text name="label.help.subHeader.fees" /> </a></h2>
			<hr class="h2-hr">
			<div id="feesPanel" class="section_panel">
		     <s:form id="downloadFeeHelpPDFFormId" action="downloadHelpPDF" namespace="/ext">		     
				<div class="highlighted">
					...
					<div class="gbg">
						<div class="span2">
							<img src="${pageContext.request.contextPath}/ext/public/img/pdf1.png" />
							<p>
		...
		<div class="form-mod">
			...
			<div id="siteAdminPanel" class="section_panel">
			   <s:form id="downloadSiteAdminHelpPDFFormId" action="downloadHelpPDF" namespace="/ext">				
				<div class="highlighted">
					<div class="form-mod smallrow">
						<div class="span5">
							<p><s:text name="label.help.selectToDownload" /></p>
		...
		<div class="form-mod">
			...
			<div id="participatingBankPanel" class="section_panel">
				<s:form id="downloadPBanksHelpPDFFormId" action="downloadHelpPDF" namespace="/ext"> 
				<div class="highlighted">
					<div class="form-mod smallrow">
						<div class="span5">
							<p><s:text name="label.help.selectToDownload" /></p>
		...
		<div class="form-mod">
			...
			<s:form id="downloadUserManualHelpPDFFormId" action="downloadHelpPDF" namespace="/ext">			
				<div class="highlighted">
					<div class="form-mod smallrow">
						<div class="span5">
							<p><s:text name="label.help.selectToDownload" /></p>
		...
		<div class="form-mod">
			...
			<div id="userRolesPanel" class="section_panel">
 			<s:form id="downloadUserRolesHelpPDFFormId" action="downloadHelpPDF" namespace="/ext">	 			
				<div class="highlighted">
					<div class="form-mod smallrow">
						<div class="span5">
							<p><s:text name="label.help.selectToDownload" /></p>
