...
<html lang="en">
  <head>
    ...
    <title><s:text name="label.request.landingPageSurety" /></title>
				...
				<div class="span4">
					<div class="box">
						...
						<div class="boxContent">
                            <ul>
								<li>
									<s:url action="displayBrokerBidProcessDashboard.action" namespace="/ext/dashboard" var="brokerBidProcessDashboardURL" />
									<c:if test="${landingpageDetails.pendingBidReplyNum gt 0}">
										<a href="<s:property value="#brokerBidProcessDashboardURL" />"><s:text name="label.request.pendingBidReply" />
								...
								<li>
									<s:url action="displayBrokerPendingIssDashboard.action" namespace="/ext/dashboard" var="brokerPendingIssDashboardURL" />
									<c:if test="${landingpageDetails.pendingIssuanceNum gt 0}">
										<a href="<s:property value="#brokerPendingIssDashboardURL" />"><s:text name="label.request.pendingIssuance" />
                                ...
                                <li>
                                	<s:url action="displayBrokerPendingRiderDashboard.action" namespace="/ext/dashboard" var="displayBrokerPendingRiderDashboardURL" >
										<s:param name="instrumentTypes">6</s:param>
									</s:url>
									<c:if test="${landingpageDetails.pendingRiderNum gt 0}">
										<a href="<s:property value="#displayBrokerPendingRiderDashboardURL" />"><s:text name="label.request.pendingRider" />
											<fmt:formatNumber type="NUMBER" value="${landingpageDetails.pendingRiderNum}" maxFractionDigits="0"/>
                                		</a>
									</c:if>
									<c:if test="${empty landingpageDetails.pendingRiderNum or 
									landingpageDetails.pendingRiderNum eq 0}">
										<s:text name="label.request.pendingRider" />
										<fmt:formatNumber type="NUMBER" value="${landingpageDetails.pendingRiderNum}" maxFractionDigits="0"/>
									</c:if>
                                </li>
							</ul>
					...
					<div class="box">
						...
						<div class="boxContent" id="closeTransactionDiv">
							<div class="radio-container">
								<label class="radio">
									<input type="radio" value="bondReferenceNumber" name="closeTransaction" class="closeTransaction">
									<s:text name="label.request.bondReferenceNumber" />
								</label>
								<label class="radio">
						...
						<div class="boxHead"><s:text name="label.request.reporting" /></div>
							<div class="boxContent">
								<div class="span3 left" style="margin:0px;">
									<h3><s:text name="label.request.suretyStandardReports" /></h3>
									<ul>
									<!-- Temporarily commented which will be available for next release -->
										...
										<li><a href="<s:property value="contigunentReport"/>"><s:text name="label.request.contingentLiabilityCurrentOutstanding"/></a></li>
