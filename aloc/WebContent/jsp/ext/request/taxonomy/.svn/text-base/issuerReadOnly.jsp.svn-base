...
<%@ taglib prefix="hwfs"  uri="/hwf-security-tags" %>
	...
	<div class="clear"></div>
		<div class="row graybg1" style="margin-left:-10px;">
		  <s:form id="downloadRequestPDFFormId" action="taxonomyDownloadRequestPDF" namespace="/ext/approver" onsubmit="return validateAttachment();">
   ...
   <s:form id="issuerSubmitForm" action="issuerSave" namespace="/ext/approver"> 
