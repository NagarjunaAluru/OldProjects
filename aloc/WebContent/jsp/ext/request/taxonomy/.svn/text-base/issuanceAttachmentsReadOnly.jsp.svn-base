...
<script type="text/javascript" src="${pageContext.request.contextPath}/ext/public/js/common/date.js"></script>
		...
		<s:set var="atmtIndex" value="0"></s:set>			
		  <s:if test="%{requestDetailsBO.attachmentBOList != null && requestDetailsBO.attachmentBOList.size>0}">    
				...
				<tr>
					...
					<td>
						<div class="alocAttachmentContainer">
							<hwfs:checkComponentPermission name="NotBankBrokerReadOnly" domainName="BusinessAccess">
							<p>
								<input type="file" class="alocFileupload" name="fileUpload"	data-url="${pageContext.request.contextPath}/ext/atmt/upload.action?typeId=3&index=<s:property value="%{#atmtBOItrStatus.index}"/>" />
							</p>
							</hwfs:checkComponentPermission>
							<div class="alocAttachment${attachmentIndex}">
								<s:if test="%{model.geFileId !=null && model.geFileId !=0}">
									<s:url id="fileDownload" action="download.action" namespace="/ext/atmt">
						...
						<hwfs:checkComponentPermission name="NotBankBrokerReadOnly" domainName="BusinessAccess">
						 <a href="javascript:;" class="need${attachmentIndex} copypasteDiv" id="linkHideId${attachmentIndex}"><img src="${pageContext.request.contextPath}/ext/public/img/arrw.png"/>
			...
			<tr>
				...
				<td>
					<div class="alocAttachmentContainer">
					<p><input  type="file" class="alocFileupload" name="fileUpload" data-url="${pageContext.request.contextPath}/ext/atmt/upload.action?typeId=3&formatId=&index=1"/></p>
					<div class="alocAttachment1"></div>	
					</div>
					<hwfs:checkComponentPermission name="NotBankBrokerReadOnly" domainName="BusinessAccess">
					 <a href="javascript:;" class="need1 copypasteDiv" id="linkHideId1"><img src="${pageContext.request.contextPath}/ext/public/img/arrw.png" /><s:text name="label.request.copyPaste" />							
		...
		<s:else>			
			<c:if test="${isIndirect}">				 
				<tr>
					...
					<td>
						...
						<c:if test="${(requestDetails.instrumentTypeId eq '1') || (requestDetails.instrumentTypeId eq '2') || (requestDetails.instrumentTypeId eq '3')  || (requestDetails.instrumentTypeId eq '4')}">
							<s:textfield cssClass="span1a" id="issuanceBankRefNo0" name="requestDetailsBO.attachmentBOList[0].issuanceBankRefNo" readonly="true" maxlength="20"/>
						</c:if>
					</td>
						...
						<div class="alocAttachmentContainer">
							...
							<p>
								<input type="file" class="alocFileupload" name="fileUpload"
									data-url="${pageContext.request.contextPath}/ext/atmt/upload.action?typeId=3&index=0" />
							</p>
							</hwfs:checkComponentPermission>
							<div class="alocAttachment0"></div>
						</div>
						<hwfs:checkComponentPermission name="NotBankBrokerReadOnly" domainName="BusinessAccess"> 
						<a href="javascript:;" class="need0 copypasteDiv" id="linkHideId0"><img src="${pageContext.request.contextPath}/ext/public/img/arrw.png"/><s:text name="label.request.copyPaste" />
			...
			<tr>
				...
				<td>
					<div class="alocAttachmentContainer">
					<hwfs:checkComponentPermission name="NotBankBrokerReadOnly" domainName="BusinessAccess">
					<p><input  type="file" class="alocFileupload" name="fileUpload" data-url="${pageContext.request.contextPath}/ext/atmt/upload.action?typeId=3&formatId=&index=0"/></p>
					</hwfs:checkComponentPermission>
					<div class="alocAttachment0"></div>	
					</div>
					<hwfs:checkComponentPermission name="NotBankBrokerReadOnly" domainName="BusinessAccess">
