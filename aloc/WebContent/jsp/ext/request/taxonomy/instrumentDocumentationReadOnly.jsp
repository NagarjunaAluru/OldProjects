	...
	<div class="row">
		<div class="span12">
		 ...
		 <div id="issuanceAttachmentRefresh">		
		   <jsp:include page="issuanceAttachmentsReadOnly.jsp"/>  			                  								
		 </div>	      			  
	            ...
	            <h2><s:text name="label.request.fees" /></h2><hr class="h2-hr">
						<div class="row">
							<div class="span12">
								...
								<s:textfield name="requestDetails.feesDetails.premiumFees" theme="aloc" maxlength="21"/> 
							</div>
					 </div>
					 ...
					 <c:if test="${(requestDetails.instrumentTypeId eq '6')}">
						   <div class="row">
								<div class="span12">
									...
									<s:textfield name="requestDetails.additionalFees" theme="aloc" maxlength="21"/>
								</div>
						   </div>
					</c:if> 
						<div class="row">
							<div class="span12">
								...
								<s:textfield name="requestDetails.feesDetails.chargeForRider" theme="aloc" maxlength="21"/>
							</div>
						</div>
						<div class="row">
						  <c:if test="${(requestDetails.instrumentTypeId eq '3') || (requestDetails.instrumentTypeId eq '6') }">
								<div class="span12">
									...
									<s:textfield name="requestDetails.feesDetails.totoalPremium" theme="aloc" maxlength="21"/>
								</div>
						  </c:if> 
						</div>	
	     </c:if>
