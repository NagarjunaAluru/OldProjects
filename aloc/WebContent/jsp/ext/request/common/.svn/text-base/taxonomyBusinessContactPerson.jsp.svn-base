			...
			<div class="span12">
				<div class="form-row">
					<s:select headerKey="" key="label.request.site"
						...
						theme="aloc" cssClass="requiredBcpField" />
									...
									<div class="form-row">
										<div class="span4 left" style="width:240px;">
											<s:textfield name="businessContactPerson" 
												 ...
												 theme="aloc" cssClass="span3 lookup-filterValue"
										...
										<div class="span2 left">
											<label>&nbsp;</label>
											<s:url action="BusinessContactPersonLookup" namespace="/ext" id="getBusinessContactPersonURL">
											...
											<img alt="Loading..." id="bcpIndicator"	class="indicator" src="${pageContext.request.contextPath}/ext/public/img/loading.gif" style="height: 20px; display: none">
										</div>
									</div>
								</div>
								
								<div class="${businessClass}" id="businessShow">
										<s:hidden name="businessContactPersonSelection" id="businessSelectionId" value="%{#requestornameSelected}" cssClass="requiredBcpField"></s:hidden>
										<s:hidden id="bcpReqCount" value="%{#requestornameSelected}"></s:hidden>
						    ...
						    <div class="row">
									<div class="form-row">
										<div class="span4 left" style="width:240px;">
											...
											<s:textfield required="false" theme="aloc" cssClass="span3 lookup-filterValue referenceTextValue" />
											<span class="lookup-error hide" style="color: #AE2C2C;"></span>
										</div>	
										<div class="span2 left" style="width:240px;">
											...
											<a class="btn-secondary lookup" href="<s:property value="#getBusinessContactPersonURL"/>" ><s:text name="label.request.common.lookup"/></a>
											<img alt="Loading..." id="bcpIndicator2"	class="indicator" src="${pageContext.request.contextPath}/ext/public/img/loading.gif" style="height: 20px; display: none">
