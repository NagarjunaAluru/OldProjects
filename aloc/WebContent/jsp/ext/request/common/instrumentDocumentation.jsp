...
<c:if test="${requestDetails.instrumentTypeId eq '4'}">
   <h2><s:text name="label.request.docUpload" /></h2><hr class="h2-hr">
	...
	<div class="row">
		...
		<jsp:include page="/jsp/ext/request/common/issuanceAttachmentRefresh.jsp" />
		</div>	      			  
	            ...
	            <h2><s:text name="label.request.fees" /></h2><hr class="h2-hr">
						<div class="row">
							<div class="span12">
								...
								<s:textfield name="requestDetails.feesDetails.premiumFees" cssClass="bigDecimal" theme="aloc"/> 
							</div>
					 </div>
					 ...
					 <c:if test="${(requestDetails.instrumentTypeId eq '6')}">
						   <div class="row">
								<div class="span12">
									...
									<s:textfield name="requestDetails.additionalFees" cssClass="bigDecimal" theme="aloc" />
								</div>
						   </div>
					</c:if> 
						<div class="row">
							<div class="span12">
								...
								<s:textfield name="requestDetails.feesDetails.chargeForRider" cssClass="bigDecimal" theme="aloc" />
							</div>
						</div>
						<div class="row">
						  <c:if test="${(requestDetails.instrumentTypeId eq '3') || (requestDetails.instrumentTypeId eq '6') }">
								<div class="span12">
									...
									<s:textfield name="requestDetails.feesDetails.totoalPremium" cssClass="bigDecimal" theme="aloc" />
								</div>
						  </c:if> 
						</div>	
	     </c:if>
...
<div class="exit-container">
     <div class="row">
                <div class="span12 request-summary">
				    <div class="form-row">
				        <s:url id="homePageURL" action="cancel" namespace="/ext/approver"/>
