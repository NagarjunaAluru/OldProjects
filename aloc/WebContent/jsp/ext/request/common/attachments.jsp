...
<s:elseif test="%{#isEditMode==false}">	
	...
	<div class="row">
		<div class="span12">
			<table class="table table-striped table-bordered attachment">
				...
				<tbody>
					<s:iterator value="taxonomyAtmtsLst" status="atmtBOItrStatus">
					<c:if test="${attachmentTypeId eq '2'}">	
								...
								<div class="alocAttachment">
									<p>
									 <s:if test="%{geFileId != null && geFileId !=0}">
										<s:url id="fileDownloadAtmt" action="download.action"
												namespace="/ext/atmt">
	...
	<c:if test="${empty issuanceflag or issuanceflag ne 'yes'}">
	<div class="row">
		<div class="span12">
			<table class="table table-striped table-bordered attachment">
				<thead>
