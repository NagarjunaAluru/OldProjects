...
<%@ taglib prefix="hwfs"  uri="/hwf-security-tags" %>
	...
	<div id="mainPage" style="width: 100%;">
			...
			<div class="form-mod">
				...
				<div class="row">
                    <div class="span6">
						...
						<jsp:include page="/jsp/ext/request/taxonomy/amendmentTreasuryApprovalRequestSection.jsp">
			...
			<div class="form-mod">
	    		<jsp:include page="/jsp/ext/request/common/auditAndTransactionHistoryLog.jsp"/>	            
   			</div>	
