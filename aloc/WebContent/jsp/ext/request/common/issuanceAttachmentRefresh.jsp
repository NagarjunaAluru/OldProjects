				...
				<tr>
					...
					<td>
						<div class="alocAttachmentContainer">
							<p>
								<input type="file" class="alocFileupload" name="fileUpload"	data-url="${pageContext.request.contextPath}/ext/atmt/upload.action?typeId=3&index=<s:property value="0"/>" />
							</p>
						...
						</div> <a href="javascript:;" class="need0 copypasteDiv" id="linkHideId0"><img src="${pageContext.request.contextPath}/ext/public/img/arrw.png"/>
