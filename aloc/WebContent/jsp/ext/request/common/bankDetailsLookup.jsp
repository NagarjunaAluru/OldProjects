		...
		<div class="span12">
			...
			<s:form id="bankAdvanceSearchForm" cssStyle="margin: 0px!important;">
			 ...
			 <div class="form-row">
				...
				<div class="span1">
					<label>&nbsp;</label>
					<s:url action="BankDetailsLookup" namespace="/ext" var="getBankDetailsURL" escapeAmp="false" encode="true">
                ...
                <div class="span1">
                   	<label>&nbsp;</label>
                   	<img alt="Loading..." id="bankIndicator" class="indicator" src="${pageContext.request.contextPath}/ext/public/img/loading.gif" style="display:none;height: 20px;width: 20px">
                </div>
				...
				<div class="span12">
					...
					<div class="row">
						...
						<div class="span2" style="margin-top: 20px;">
							<s:url action="BankAdvanceSearchLookup" namespace="/ext" var="bankAdvanceSearchURL" escapeAmp="false" encode="true">
								<s:param name="pageNumber">1</s:param>
							</s:url>
							...
							src="${pageContext.request.contextPath}/ext/public/img/loading.gif" style="height: 20px; display:none">
						</div>
					</div>
				</div>
			</div>
				...
				<div class="row" id="hideLessthan10">
					...
					<div class="span33 right" id="bankPageDivID">
				    	...
				    	<s:if test="%{bankName != null}">
					    	<s:url action="BankDetailsLookup" namespace="/ext" var="getPreviousBankURL" escapeAmp="false" encode="true">
						...
						<s:else>
							<s:url action="BankAdvanceSearchLookup" namespace="/ext" var="getPreviousBankURL" escapeAmp="false" encode="true">
					    		<s:param name="pageNumber"><s:property value="previousPageStart"/> </s:param>
							</s:url>
			           	...
			           	<s:if test="%{bankName != null}">
				           	<s:url action="BankDetailsLookup" namespace="/ext" var="getNextBankURL" escapeAmp="false" encode="true">
						...
						<s:else>
							<s:url action="BankAdvanceSearchLookup" namespace="/ext" var="getNextBankURL" escapeAmp="false" encode="true">
					    		<s:param name="pageNumber"><s:property value="nextPageStart"/></s:param>
							</s:url>
			           	...
			           	<img alt="Loading..." id="next100LEIndicator" class="indicator" src="${pageContext.request.contextPath}/ext/public/img/loading.gif" style="height: 20px; display:none">
			        </div>
