	   ...
	   <%@include  file="/jsp/ext/common/headerSection.jsp" %>
			...
			<div class="span12 bluebg">
				...
				<div class="row lastrow">
					...
					<c:if test="${apmDetails.feeSummaryDetails.feeRequestSummary.applicant.userDetails.firstName eq null &&
									apmDetails.feeSummaryDetails.feeRequestSummary.applicant.userDetails.lastName eq null}">
	                 -</c:if>
                     <s:property value="apmDetails.feeSummaryDetails.feeRequestSummary.applicant.userDetails.firstName"/>,
   					 <s:property value="apmDetails.feeSummaryDetails.feeRequestSummary.applicant.userDetails.lastName"/></div>
				</div>
				<div class="row lastrow">
					<div class="span2">
		...
		<div class="row">
			<div class="span12">
                ...
                <s:form name="feeSummaryForm" action="openRequest" namespace="/ext">
					...
					<s:submit cssClass="submitLink right" value="View Full Request" action="openRequest" namespace="/ext" />
				</s:form>	
			</div>
		</div>
						...
						<tbody>
			            	...
			            	<tr>
								...
								<td><p><c:if test="${bPsRateInArrears eq null}">
	                              -
                                </c:if><s:property value="bPsRateInArrears"/></p></td>
								<td><p><c:if test="${bPsRateInAdvance eq null}">
	                              -
                                </c:if><s:property value="bPsRateInAdvance"/></p></td>
							...
							<tr>
								<td colspan="9" align="center" style="border-right:0px Solid #000;"><span class="right"><s:text name="label.request.USFees.totalAmendment"/></span></td>
							...
							<tr>
								<td colspan="9" align="center" style="border-right:0px Solid #000;"><span class="right"><s:text name="label.request.USFees.totalPayment"/></span></td>
				...
				<div class="span12">
					<table class="table table-striped table-bordered sortable no-bottom">
		            	...
		            	<tr>
							...
							<tr>
								<td colspan="9" align="center" style="border-right:0px Solid #000;"><span class="right"><s:text name="label.request.foreignFees.totalAmendment"/></span></td>
							...
							<tr>
								<td colspan="9" align="center" style="border-right:0px Solid #000;"><span class="right"><s:text name="label.request.foreignFees.totalPayment"/></span></td>
