...
<div class="row">
	<div class="span12">
		<div class="form-row">
		   <s:form name="basicSearchForm" id="basicSearchFormID" action="basicFHSearch.action" namespace="/ext/admin">
			...
			<s:url action="basicFHSearch.action" var="basicSearchDashboardURL" namespace="/ext/admin" encode="true" escapeAmp="false"/>
			...
			<jsp:include page="/jsp/ext/apm/advanceSearchInFeeHistory.jsp"> 
