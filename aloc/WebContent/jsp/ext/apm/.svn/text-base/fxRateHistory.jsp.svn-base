	            ...
	            <div class="row">
					...
					<div class="span2">
                     ...
                     <div class="span2">
                      ...
                      <div class="span1">
					      <img alt="Loading..." id="periodProcessImgOne" src="${pageContext.request.contextPath}/ext/public/img/loading.gif" style="display:none;height: 20px;width: 20px;">
                     </div>
                      
				</div>
				<div class="row">
					 <div id="includeFxPeriod" class="span5">
					      <jsp:include page="/jsp/ext/apm/fxRateperiodSelect.jsp" />
					</div>
				</div>
