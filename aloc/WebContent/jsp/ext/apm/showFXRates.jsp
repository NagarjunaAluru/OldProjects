...
<%@ taglib prefix="hwfs"  uri="/hwf-security-tags" %>
 ...
 <link href="${pageContext.request.contextPath}/ext/public/css/common/site.css" type="text/css" rel="stylesheet" />
...
<div id="payment">
					<div class="span12">
						<div class="row">
							<div class="span12">
								<h3><s:text name="label.request.results" /> <span class="right"><a href="javascript:;" onclick="printContent('printFXRates')"><img src="${pageContext.request.contextPath}/ext/public/img/print.gif" border="0" /></a></span></h3>	
							...
							<div class="span6 left active" id="printFXRates">
								...
								<br />
								<s:url id="downloadURL" action="downloadResultExport" namespace="/ext/apm">
