...
<html>
	<head>
	    ...
	    <script type="text/javascript" src="${pageContext.request.contextPath}/ext/public/js/ext/reports/userReport.js"></script>
				            ...
				            <div class="row">
				            	<div class="span12">
				            		<div class="row">
				            			<div class="span12">
				            				<div class="form-row">
												<b><s:text name="label.report.bankName"/>&nbsp;<s:text name="bankName"></s:text></b>
											</div>
										</div>
										<%-- <div class="span1">	
											<div class="form-row">
												<b><s:text name="bankName"></s:text></b>
											</div>
										</div> --%>
									</div>
								</div>
							...
							<div class="row">
								<div class="span12">
									<div class="form-row">
										...
										<s:url action="UserDetailsLookup" namespace="/ext" var="getBusinessContactPersonURL" escapeAmp="false" encode="true">
