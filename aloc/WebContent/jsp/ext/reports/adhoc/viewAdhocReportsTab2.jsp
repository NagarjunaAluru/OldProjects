	...
	<div class="row">
		...
		<div class="span12">
					...
					<s:iterator value="adhocReports.publishedReports" >
						<tr class="shown">
							<td style="text-align: center;">
								...
								<s:form action="deleteTemplate.action" namespace="/ext/reports" name="deleteTemplateForm" 
							...
							<td>
								<s:form action="openTemplate.action" namespace="/ext/reports" name="publishedReportsOpenTemplate"
			...
			<script type="text/javascript"
				src="${pageContext.request.contextPath}/ext/public/js/common/pagination.js"></script>
