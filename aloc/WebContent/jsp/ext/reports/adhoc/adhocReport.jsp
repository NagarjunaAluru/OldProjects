...
<head>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/ext/public/js/plugins/jquery-ui-1.9.2.custom.js"></script>
    <link href="${pageContext.request.contextPath}/ext/public/css/others/toggle.css" rel="stylesheet"/>
    
    
    <!-- JTree Component CSS and JS -->
    <script src="${pageContext.request.contextPath}/ext/public/js/toggle/toggle.js"></script>
	...
	<script src="${pageContext.request.contextPath}/ext/public/js/ext/reports/adhocReports.js"></script>
    ...
    <!-- Tree Structure -->
	<link rel="stylesheet" href="${pageContext.request.contextPath}/ext/public/css/others/jquery.treeview.css" />
	<script src="${pageContext.request.contextPath}/ext/public/js/others/jquery.cookie.js" type="text/javascript"></script>
	<script src="${pageContext.request.contextPath}/ext/public/js/others/jquery.treeview.js" type="text/javascript"></script>
...
<body>
	...
	<div id="mainPage" style="width: 100%;">
		<div class="form-mod">
			<h2 class="page-title span12"><s:text name="label.report.createCustomReport"></s:text></h2><hr class="h2-hr">
		</div>
	...
	<div class="form-mod">
		<h2 class="acc_trigger1 acc_active"><a href="javascript:;"><s:text name="label.report.customFilter"/></a></h2><hr class="h2-hr">
		<div class="acc_container1">
            <a name="first"></a>
			<h3 class="zeroborder" id="reportName">
											...
											<div class="row lastrow">
												<div class="span3">
													...
													<s:iterator value="%{#attr['com.ge.aloc.StaticDataFactory'].instrumentType}" status="stat">
														<label class="checkbox">
															<s:checkbox name="instrumentTypes" value="%{name}" fieldValue="%{ID}" cssClass="instrumentTypes case"/><s:property value="name"/>
														</label>
													</s:iterator>
								...
								<div class="row review lastrow">
									<div class="form-mod">
										<div class="row">
											...
											<img alt="Loading..." class="indicator right" 
																...
																<div class="hide columnOrderPriority">
																	...
																	<div class="left">
																		...
																		name="template.columns[\'alocRecordNo\'].sortOrder"
																	 	list="#{'asc':'Ascending' , 'dsc':'Descending'}" 
...
<div id="reportGridId">
		...
		<div>
			<jsp:include page="/jsp/ext/reports/adhoc/downLoadAndSaveTemplate.jsp"/>
		</div>
	</s:form>	
</div>
