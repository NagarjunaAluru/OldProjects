...
<div class="right" style="width: 20%;">
	...
	<img alt="delete" src="${pageContext.request.contextPath}/ext/public/img/delete.gif" style="margin-top: 5px; margin-left: 5px;"></a>
</div>

<script type="text/javascript" src="${pageContext.request.contextPath}/ext/public/js/reports/filterController.js"></script>
