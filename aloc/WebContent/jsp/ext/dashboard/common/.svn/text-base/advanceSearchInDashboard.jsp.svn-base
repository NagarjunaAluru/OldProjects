...
<s:form name="advanceSearchForm" id="advanceSearchFormID" action="advanceSearch.action" namespace="/ext/dashboard">
			...
			<table id="bondSubBondTable" style="width: 100%;">
				<tr>
					<td height="1" class="noPadding">
						...
						<img alt="Loading..." class="indicator" src="${pageContext.request.contextPath}/ext/public/img/loading.gif" 
	...
	<div class="row">
		<div class="span2 hide model">
            ...
            <sj:autocompleter id="applicantCountryCd" list="%{#attr['com.ge.aloc.MasterDataFactory'].countries}" 
				...
				cssClass="span2" listKey="countryCode" listValue="countryName" headerKey="" headerValue="Select..."/>
        </div>
	...
	<div class="row">
			...
			<div class="form-row">
				<div>
					<sj:autocompleter list="%{#attr['com.ge.aloc.MasterDataFactory'].currencies}"
						...
						cssClass="span2" listKey="currencyCode" listValue="currencyName" headerKey="" headerValue="Select..." onChangeTopics="getAutocompleterName"/>
		...
		<div class="span4 hide mtard bidProcess" id="countryI">
			...
			<div>
					...
					cssClass="span2" listKey="countryCode" listValue="countryName" headerKey="" headerValue="Select..." onChangeTopics="getAutocompleterName"/>
					<br>
...
<c:if test="${param.forPage eq 'Dashboard'}">
	<s:url action="advanceSearch.action" var="advanceSearchDashboardURL" namespace="/ext/dashboard" encode="true" escapeAmp="false"/>
</c:if>
