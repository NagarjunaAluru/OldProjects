				...
				<div class="tab" id="tab2" style="padding:10px; background:#fff; border:Solid 3px #ccd7e5;">
					...
					<div class="row">
						...
						<table>
							...
							<s:textarea name="template.description" onkeypress="return imposeMaxLength(this, 199);"
							 theme="aloc" cssClass="autosize2 messageinput" id="templateDesc"/>
						 	<div class="clear"></div>
			...
			<div class="row hide" id="PublishBank">
				<div class="span2ab">
					<div class="form-row" style="width: 200px !important" id="bankSelection">
						<jsp:include page="/jsp/reports/adhoc/adhocBankSelection.jsp" />
					</div>
				</div>
			</div>
			<div class="row hide" id="PublishBusiness">
				<div class="span2ab">
					<div class="form-row" style="width: 200px !important" id="siteSelection">
						<jsp:include page="/jsp/reports/adhoc/adhocSiteSelection.jsp" />
					</div>
				</div>
			</div>
