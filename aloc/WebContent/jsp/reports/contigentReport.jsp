...
<html>
	<head>
	    ...
	    <script type="text/javascript" src="${pageContext.request.contextPath}/js/reports/contingent.js"></script>
	...
	<body>
		<div class="container main">
	    	...
	    	<form id="contingentForm"  method="post">
	    		...
	    		<s:hidden id="siteType" name="reportsDetails.contingentliabilityDetails[0].siteTypes[0]"></s:hidden>
				...
				<div class="form-mod">
					...
					<hr class="h2-hr"/>
	     			<div class="acc_containerA">
						...
						<hwfs:checkComponentPermission name="IssuanceBankUserAccess" domainName="BusinessAccess">
							<s:hidden id="bloombergId" name="bloombergRate"></s:hidden>
							<s:hidden id="contigentBUCId" value="%{getText('ALOC_Contigent_BUC_URL')}" ></s:hidden>
						</hwfs:checkComponentPermission>
						<!-- Role based access setting here -->
						<hwfs:checkComponentPermission name="IssuanceGEUserAccess" domainName="BusinessAccess">
							<div class="row" id="divFxRateBorderId" style="margin-left: 1px; margin-bottom:1px;">
								<div class="span4" style="margin-left: 1px; margin-bottom:1px;">
								    <s:hidden id="contigentPathId" value="%{getText('ALOC_Contigent_Liability_URL')}"></s:hidden>
									<div class="form-row">
										<s:label key="label.report.fxRateSelection" theme="aloc"></s:label>
									</div>
									<div class="form-row">
			                            <s:radio name="reportsDetails.contingentliabilityDetails[0].fxRateBloomberg" cssClass="radio" id="fxRateSelection" list="#{'MOR':'MOR','Bloomberg':'Bloomberg'}" theme="aloc" labelposition="right"/>								
								    </div>
								</div>
						...
						<hwfs:checkComponentPermission name="TreasuryDashboardAccess" domainName="BusinessAccess">
							<div class="row">
								<div class="span2ab">
									<div class="form-row">
										<s:label key="label.report.labelReportAs" theme="aloc"></s:label>
									</div>
									<div class="form-row">
			                            <s:radio name="reportsDetails.contingentliabilityDetails[0].buc" cssClass="radio" id="preliminaryRadio" list="#{'Preliminary':'Preliminary','Final':'Final'}" theme="aloc" labelposition="right"/>								
								    </div>
								</div>
							</div>
					   </hwfs:checkComponentPermission>
