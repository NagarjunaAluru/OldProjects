...
<html>
	<head>
	    ...
	    <script type="text/javascript" src="${pageContext.request.contextPath}/js/reports/bidSuccess.js"></script>
				...
				<div class="form-mod">
					...
					<div class="acc_containerA">
						...
						<div class="row">
							...
							<div class="span4">
								<div class="form-row">
										<s:label key="label.report.currencyOfIssuance" theme="aloc"/>
										<sj:autocompleter key="label.report.currencyOfIssuance" id="instrCurrencyId"
							...
							<div class="span12" style="margin-left: 0px;">
								<div class="form-row">
									<table class="table table-striped table-bordered sortable">
										<thead>
											<tr><th colspan="5"><s:text name="label.report.groupResultsBy"/></th></tr>
										</thead>
										<tbody>
											<tr>
