...
<head>
	...
	<%-- <script src="${pageContext.request.contextPath}/js/requestor/bgRequiredCount.js" type="text/javascript"></script> --%>
	...
	<div id="requestSummary">
		...
		<div class="form-mod">
        	<c:choose>
        		...
        		<c:when test="${taxonomyViewType eq 'UPDATEDATA'}">
        			<c:set var="myUpdatedataClass" value="active"></c:set>
        			<c:set var="myUpdatedataTab" value="active in"></c:set>
        		</c:when>
        	</c:choose>
			...
			<s:url action="RequestorAtmtTaxonomy.action" namespace="/int" escapeAmp="false" var="requestURL" >
				...
				<s:param name="instrumentId"><s:property value="requestDetails.instrumentTypeId"/></s:param>
				<s:param name="wfid"><s:property value="requestDetails.WFDetails.WFID"/></s:param>
				<s:param name="queueName"><s:property value="requestDetails.WFDetails.queueName"/></s:param>
				<s:param name="procedureName"><s:property value="requestDetails.WFDetails.procedureName"/></s:param>
			</s:url>
			
			<s:url action="AmendmentsTaxonomy.action" namespace="/int" escapeAmp="false" var="amendmentsURL" >
				<s:param name="requestId"><s:property value="requestDetails.requestId"/></s:param>
				<s:param name="returnToPage"><s:property value="returnToPage"/></s:param>
			</s:url>
			
			<s:url action="FeeHistoryTaxonomy.action" namespace="/int"	escapeAmp="false" var="feeHistoryURL" >
				<s:param name="requestId"><s:property value="requestDetails.requestId"/></s:param>
				<s:param name="returnToPage"><s:property value="returnToPage"/></s:param>
			</s:url>
			
			<s:url action="LinkTansactionsTaxonomy.action" namespace="/int"	escapeAmp="false" var="linkURL" >
				<s:param name="requestId"><s:property value="requestDetails.requestId"/></s:param>
				<s:param name="returnToPage"><s:property value="returnToPage"/></s:param>
			</s:url>
			
			<s:url action="BundleTansactionsTaxonomy.action" namespace="/int" escapeAmp="false"	var="bundleURL" >
				<s:param name="requestId"><s:property value="requestDetails.requestId"/></s:param>
				<s:param name="returnToPage"><s:property value="returnToPage"/></s:param>
			</s:url>
			
			<s:url action="CompBidRepliesTaxonomy.action" namespace="/int"	escapeAmp="false" var="compBidRepliesURL" >
				<s:param name="requestId"><s:property value="requestDetails.requestId"/></s:param>
				<s:param name="returnToPage"><s:property value="returnToPage"/></s:param>
			</s:url>
			
			<s:url action="CurrBankFeesTaxonomy.action" namespace="/int" escapeAmp="false" var="currBankFeesURL" >
			...
			<s:url action="getReportingData.action" namespace="/int" escapeAmp="false" var="getReportingDataURL" >
				<s:param name="requestId"><s:property value="requestDetails.requestId"/></s:param>
				<s:param name="returnToPage"><s:property value="returnToPage"/></s:param>
			</s:url>
			...
			<ul class="nav nav-tabs nav-tabsapm tabs">
				...
				<hwfs:checkComponentPermission name="CurrentBankFeeAccess" domainName="BusinessAccess">
					<li class="${myCurrBankFeeClass}"><a href="<s:property value="currBankFeesURL" />"><s:text name="label.request.currentbankfees"/></a></li>
				</hwfs:checkComponentPermission>
				...
				<hwfs:checkComponentPermission name="TransactionsHistoryAccess" domainName="BusinessAccess">
					<c:if test="${requestDetails.WFDetails.WFStageID eq 15}">
						<li class="${myUpdatedataClass}"><a href="<s:property value="getReportingDataURL" />"><s:text name="label.request.updateReportingData" /></a></li>
					</c:if>
				</hwfs:checkComponentPermission>
			...
			<div class="tab-content" id="myTabContent">
				...
				<div id="1" class="tab-pane fade ${myReqTab}">
					<s:form id="bgTaxonomyForm" action="updateTaxonomyRequest" namespace="/int" >
				...
				<div id="6" class="tab-pane fade ${myAuditLogTab}">
				 		    <s:if test="%{requestDetails.auditLogs.size>5}">
						      ...
						      <p class="right"><a class="fullScreen"  href="<s:property value="#showFullAuditLog"/>" onclick="javascript:showAuditProcess();"><s:text name="label.request.auditLog.fullAuditLog"/></a>
						    </s:if>
				...
				<div id="9" class="tab-pane fade ${myCurrBankFeeTab}">
					<s:form id="cuuBankForm" action="saveCurrBankFees" namespace="/int" >
						<jsp:include page="/jsp/common/request/taxonomy/taxonomyCurrentBankFees.jsp">
							<jsp:param name="includeScripts" value="false" />
       					</jsp:include>
       					<input type="hidden" name="returnToPage" value="${returnToPage}">
       					<div class="clear"></div>
				...
				<hwfs:checkComponentPermission name="TransactionsHistoryAccess" domainName="BusinessAccess">
				<div id="12" class="tab-pane fade ${myUpdatedataTab}">
					<s:form id="updateReportingForm" action="updateReportingData" namespace="/int" >
						<jsp:include page="/jsp/common/request/taxonomy/updateReportingData.jsp">
							<jsp:param name="includeScripts" value="false" />
						</jsp:include>
						...
						<div class="clear"></div>
							...
							<c:if test="${ updateReportingData.AMDExists ne 'Y'}">
								<s:submit value="Apply Changes" cssClass="btn-primary" id="updateReportingDataBut">
								</s:submit>
								&nbsp;&nbsp;&nbsp;<a href="<s:property value="getReportingDataURL" />" class="btn-secondary"><s:text name="label.request.resetToOriginalValues"></s:text> </a>
							</c:if>
								<a href="<s:property value="#cancelLinkURL" />" class="btn-tertiary cancel"><s:text name="label.request.common.cancel"></s:text></a>
							</div>
						</c:if>
						<c:if test="${empty updateReportingData}">
							<a href="<s:property value="#cancelLinkURL" />" class="btn-tertiary cancel"><s:text name="label.request.common.cancel"></s:text></a>
						</c:if>
						<s:hidden id="actionTypeId" name="actionType" value="1"></s:hidden>
						<s:hidden id="taxonomyViewType" name="taxonomyViewType" ></s:hidden>
						<s:hidden name="updateReportingData.alocRequestId"/>
						<s:hidden name="updateReportingData.lastUSPaidDateFlag"/>
						<s:hidden name="updateReportingData.lastForeignPaidDateFlag"/>
						<s:hidden name="updateReportingData.issuanceDateFlag"/>
						<s:hidden name="updateReportingData.AMDExists"/>
						<s:hidden name="requestId" value="%{requestDetails.requestId}" id="requestId"/>
						<s:hidden name="updateReportingData.percentValueOfBid" value="%{updateReportingData.percentValueOfBid}" id="updatedPercentValueOfBid"/>
						<s:hidden name="updateReportingData.bidUSDEquivalent" value="%{updateReportingData.bidUSDEquivalent}" id="updatedBidUSDEquivalentAmount"/>		
						<input type="hidden" name="returnToPage" value="${returnToPage}">
					</s:form>
				</div>
				</hwfs:checkComponentPermission>
