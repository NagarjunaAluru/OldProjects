...
<body>
	<div class="container main">
		...
		<div class="form-mod">
        	...
        	<s:url action="LinkTansactionsTaxonomy.action" namespace="/int"	var="linkURL" >
				<s:param name="requestId"><s:property value="requestDetails.requestId"/></s:param>
			</s:url>
			
			<s:url action="BundleTansactionsTaxonomy.action" namespace="/int" var="bundleURL" >
				<s:param name="requestId"><s:property value="requestDetails.requestId"/></s:param>
			</s:url>
			...
			<div class="tab-content" id="myTabContent">
				...
				<div id="1" class="tab-pane fade ${myReqTab}">
					<s:form id="dlocRequestForm" action="updateTaxonomyRequest" namespace="/int" >
