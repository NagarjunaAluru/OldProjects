...
<link href="${pageContext.request.contextPath}/css/others/closure.css" type="text/css" rel="stylesheet" />  
...
<body>
    <div class="container main">
		...
		<s:form id="closureSubmitForm"  namespace="/int/approver">
		<div id="mainPage">
			...
			<div class="form-mod">		
				...
				<div class="row">
					<div class="span12">
						...
						<c:if test="${requestDetails.instrumentTypeId eq '6'}"><s:property value="requestDetails.rider.riderRequestId"/></c:if>
						</p>
		...
		<div class="form-mod">
				<jsp:include page="applicantAddress.jsp" />
		</div>
	    <div class="clear"></div>
	    
    	<!-- Including obligee/beneficiary Details -->
		<div class="form-mod">
				<jsp:include page="beneficiaryAddress.jsp" />
		</div>
	    <div class="clear"></div>
	   ...
	   <br/>
		...
		<div class="form-mod">	
                     ...
                     <jsp:include page="/jsp/common/closureAttachments.jsp"/>
				</div>
	</div>
		<div class="clear"></div>
	<div class="form-mod"> 
