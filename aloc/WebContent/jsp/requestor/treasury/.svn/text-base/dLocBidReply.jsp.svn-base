...
<title><s:property value="requestDetails.instrumentType" /> -
	...
	<script src="${pageContext.request.contextPath}/js/requestor/bidReply.js" type="text/javascript"></script>
</head>
...
<body>
	<div class="container main">
		...
		<div id="mainPage" style="width: 100%;">
			...
			<s:form id="dLocBidReplyForm" action="dlocBidReply" namespace="/int/approver" >
