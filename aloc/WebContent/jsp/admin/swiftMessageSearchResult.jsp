...
<s:url action="resendSwiftMessageMonitoring.action"	namespace="/int/admin" var="reSendURL" />

<h1 class="page-title span12">
	<s:text name="label.swiftMessageMonitoring.pagaeTitle" />
</h1>
...
<div class="row" id="hideLessthan10">
	<div class="span3">
		<p id="itemsPerPage">
			<span id="start"></span> - <span id="end"></span> of <span id="total"></span>
			items
		</p>
	</div>
	<div class="span2 right">
		Show&nbsp;&nbsp; <select style="width: 60px !important;"
		...
		<s:else>
			<s:iterator value="swiftDashBoard.swiftMonitorings">
				<tr class="shown">
					...
					<td><s:iterator value="instruments">
							<s:property />
							<br />
						</s:iterator></td>
				</tr>
	...
	<div class="span right">
		...
		<div class="span3 jump-page">
			Jump to <input type="text" class="span1 manual"> <a
				class="btn btn-success-blue" type="submit">Go</a>
		</div>
	</div>
</div>
