...
<div id="${cc:getSectionColor(param.rowIdValue)}">  
 <s:form name="bankPendingIssuanceExpForm" id="bankPendingIssuanceExpFormID" action="openRequest" namespace="/int">                           
    <div class="innerBankBS">
	    <hwfs:checkComponentPermission name="NotBankBrokerReadOnly" domainName="BusinessAccess">
                	...
                	<s:submit key="label.dashboard.expandLabel.commenceIssuance" action="openRequest" namespace="/int" cssClass="expandRequestLink btn-secondary"/>
                <div class="clear"></div>
