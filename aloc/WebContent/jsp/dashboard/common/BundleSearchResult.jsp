...
<table id="tableBundles" class="table table-striped sortable table-bordered paginate">
	...
	<thead>
		<tr id="column_head">
			...
			<th><s:text name="label.dashboard.tableHeader.bundleStatus"/><span class="ttip info" data-original-title="This is an tooltip with more information"></span></th>
	...
	<tbody>
		<s:if test="%{searchResult.bundle == null || searchResult.bundle.requestDetails.isEmpty()}">
        ...
        <s:else>
        <s:iterator value="searchResult.bundle.requestDetails">
		<tr class="shown">
			<td style="width: 70px;">
