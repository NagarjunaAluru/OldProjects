...
<table id="report" class="table table-striped sortable table-bordered paginate">
	...
	<thead>
        ...
        <tbody>
        	<s:if test="%{searchResult.myTransactions == null || searchResult.myTransactions.dashBoards.isEmpty()}">
        	...
        	<s:else>
        	<s:iterator value="searchResult.myTransactions.dashBoards" status="stat">
               	<tr class="shown">
