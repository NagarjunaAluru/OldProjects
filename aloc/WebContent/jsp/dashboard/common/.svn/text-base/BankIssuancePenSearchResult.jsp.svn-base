...
<table id="tableBankPendingIssuance" class="table table-striped sortable table-bordered paginate">
	...
	<thead>
        ...
        <tbody>
        	<s:if test="%{searchResult.pendingIssuance == null || searchResult.pendingIssuance.dashBoards.isEmpty()}">
        	...
        	<s:else>
        	<s:iterator value="searchResult.pendingIssuance.dashBoards" status="stat">
               	<tr class="shown">
                ...
                <td>
                	<s:form name="bankPendingIssuanceForm" id="bankPendingIssuanceFormID" action="openRequest" namespace="/int">
