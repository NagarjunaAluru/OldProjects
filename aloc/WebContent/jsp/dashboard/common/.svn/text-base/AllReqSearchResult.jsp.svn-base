...
<table id="allRequests" class="table table-striped sortable table-bordered paginate">
	...
	<thead>
        ...
        <tbody>
        	<s:if test="%{searchResult == null || searchResult.allRequests == null || searchResult.allRequests.dashBoards.isEmpty()}">
        	...
        	<s:else>
        	<s:iterator value="searchResult.allRequests.dashBoards" status="stat">
        	...
        	<tr class="shown" >
                ...
                <td>
                	...
                	<c:if test="${not empty currencyCd}">
                		<c:out value="${currencyCd}" />
                	</c:if>
                </td>
                <td>
                	<c:choose>
