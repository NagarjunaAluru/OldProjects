...
<table id="tableBankHistoricalTrans" class="table table-striped sortable table-bordered paginate">
	...
	<thead>
        ...
        <tbody>
        	<s:if test="%{searchResult.histroricalTransactions == null || searchResult.histroricalTransactions.dashBoards.isEmpty()}">
        	...
        	<s:else>
        	<s:iterator value="searchResult.histroricalTransactions.dashBoards" status="stat">
        	...
        	<tr class="shown">
                ...
                <td>
                	<s:form name="bankHistoricalTransForm" id="bankHistoricalTransFormID" action="openRequest" namespace="/int">
	                	...
	                	<input type="hidden" name="historicalTab" value="yes" class="historicalTab">
	                	<input type="hidden" name="issuanceflag" value="yes">
