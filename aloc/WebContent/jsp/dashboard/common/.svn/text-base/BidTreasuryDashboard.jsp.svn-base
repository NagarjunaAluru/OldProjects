...
<table id="tableBidProcessT" class="table table-striped sortable table-bordered paginate">
	<thead>
        ...
        <tbody>
        	<s:if test="%{results.treasuryBidProcess == null || results.treasuryBidProcess.bidProcess.isEmpty()}">
        	...
        	<s:else>
        	<s:iterator value="results.treasuryBidProcess.bidProcess" status="stat">
              	<tr class="shown" >
