...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>				
            ...
            <c:choose>
				...
				<c:otherwise>
		            ...
		            <p><b><s:text name="label.dashboard.modal.body.surety" /></b>&nbsp;
		            <div style="word-wrap: break-word;"><s:property value="issuingBankName"/>&nbsp;<s:text name="label.dashboard.modal.body.for" />&nbsp;<s:property value="requestDetailsList[0].alocRecordId"/></div></p>
				</c:otherwise>
		    </c:choose>
            <br>
				 <table class="table table-striped table-bordered selectWinnerFromBP">
				       <thead>
				                  <tr>				                   
			...
			<br>		
	            ...
	            <div class="radio-container">
					...
					<s:hidden name="workFlowstageId" value="%{stage}"> </s:hidden>
					<s:hidden name="sitePrefix" value="%{sitePrefix}"> </s:hidden>
					<s:hidden name="selBidWinnerType" value="fromDashboard"> </s:hidden>
					<s:hidden name="instrumentId" value="%{instrumentTypeId}" id="instrumentId"> </s:hidden>
	<script type="text/javascript">
	$(document).ready(function(){
		$("table.selectWinnerFromBP tr:odd").addClass("odd");
	});
	</script>