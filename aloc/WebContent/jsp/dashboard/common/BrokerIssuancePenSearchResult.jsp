        ...
        <tbody>
        	...
        	<tr class="shown">
                <td id="${cc:getRowId(instrumentID, instrumentPurposeId, bondTypeId, subBondTypeId)}" style="width: 100px;">
                	...
                	<img alt="Loading..." class="dashboardExpandViewProcess" src="${pageContext.request.contextPath}/img/loading.gif" style="display:none;height: 20px;width: 20px; margin-left: 0px; margin-top: -10px; margin-bottom: -5px;">
                </td>
                <td>
