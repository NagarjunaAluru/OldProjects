...
<table id="report" class="table table-striped sortable table-bordered paginate">
	...
	<thead>
        ...
        <tbody>
        	<s:if test="%{results.myTransactions == null || results.myTransactions.dashBoards.isEmpty()}">
        	...
        	<s:else>
        	<s:iterator value="results.myTransactions.dashBoards" status="stat">
        	        	
        	        	<c:choose>
        	        	<c:when test="${not empty bundleId and instrumentType ne 'Amendment'}">
        	        	<tr class="shown">
        	        <td style="background-color: #D3D3D3 !important;margin: 10px;padding: 0px 0px 0px 6px;" id="${cc:getRowId(instrumentID, instrumentPurposeId, bondTypeId, subBondTypeId)}">
                	...
                	<s:form name="myTransactionForm" id="myTransactionFormID" action="openRequest" namespace="/int">
	                	...
	                	<input type="hidden" name="requestorSSO" value="${requestorSSO}" class="requestorSSO">
                ...
                <td style="word-wrap: break-word; width: 65px;background-color:#D3D3D3;">
	            ...
	            <td style="word-wrap: break-word;background-color:#D3D3D3;">
