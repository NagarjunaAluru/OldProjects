...
@XmlRootElement(name = "ApplicantDetails", namespace = "http://treasury.ge.com/schemas/ALOC/RequestDetails/ApplicantDetails.xsd")
    ...
    implements Serializable
{
    ...
    @XmlElement(name = "Op_Code", namespace = "http://treasury.ge.com/schemas/ALOC/RequestDetails/ApplicantDetails.xsd")
    ...
    @XmlElement(name = "Comments", namespace = "http://treasury.ge.com/schemas/ALOC/RequestDetails/ApplicantDetails.xsd")
    protected String comments;
    @XmlElement(name = "Requires_Edits", namespace = "http://treasury.ge.com/schemas/ALOC/RequestDetails/ApplicantDetails.xsd")
    protected Boolean requiresEdits;
    @XmlElement(name = "Send_Back_Notes", namespace = "http://treasury.ge.com/schemas/ALOC/RequestDetails/ApplicantDetails.xsd")
    ...
    public ApplicantDetails withOpCode(String value) {
        setOpCode(value);
        return this;
    }

    public ApplicantDetails withAddressDtls(AddressDtls value) {
        setAddressDtls(value);
        return this;
    }

    public ApplicantDetails withRefDetails(RefDetails... values) {
        if (values!= null) {
    ...
    public ApplicantDetails withRefDetails(Collection<RefDetails> values) {
        if (values!= null) {
    ...
    public ApplicantDetails withComments(String value) {
        setComments(value);
        return this;
    }

    public ApplicantDetails withRequiresEdits(Boolean value) {
        setRequiresEdits(value);
        return this;
    }

    public ApplicantDetails withSendBackNotes(String value) {
