...
@XmlRootElement(name = "Retention_Recipient", namespace = "http://treasury.ge.com/schemas/ALOC/Admin/RecordRetention.xsd")
public class RetentionRecipient
    extends JAXBObjectSecureSerializer
    implements Serializable
{

    private final static long serialVersionUID = 1L;
    @XmlElement(name = "Recipient_First_Name", namespace = "http://treasury.ge.com/schemas/ALOC/Admin/RecordRetention.xsd")
    protected String recipientFirstName;
    @XmlElement(name = "Recipient_Last_Name", namespace = "http://treasury.ge.com/schemas/ALOC/Admin/RecordRetention.xsd")
    protected String recipientLastName;
    @XmlElement(name = "Recipient_Sso_Id", namespace = "http://treasury.ge.com/schemas/ALOC/Admin/RecordRetention.xsd")
    protected String recipientSsoId;
    @XmlElement(name = "Recipient_Email", namespace = "http://treasury.ge.com/schemas/ALOC/Admin/RecordRetention.xsd")
    ...
    public RetentionRecipient withRecipientFirstName(String value) {
        setRecipientFirstName(value);
        return this;
    }

    public RetentionRecipient withRecipientLastName(String value) {
        setRecipientLastName(value);
        return this;
    }

    public RetentionRecipient withRecipientSsoId(String value) {
        setRecipientSsoId(value);
        return this;
    }

    public RetentionRecipient withRecipientEmail(String value) {
