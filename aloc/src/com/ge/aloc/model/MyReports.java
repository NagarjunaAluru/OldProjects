...
@XmlRootElement(name = "MyReports", namespace = "http://treasury.ge.com/schemas/ALOC/ADHOC/MyReports.xsd")
    ...
    implements Serializable
{
    ...
    @XmlElement(name = "ReportID", namespace = "http://treasury.ge.com/schemas/ALOC/ADHOC/MyReports.xsd")
    protected BigInteger reportID;
    @XmlElement(name = "ReportName", namespace = "http://treasury.ge.com/schemas/ALOC/ADHOC/MyReports.xsd")
    protected String reportName;
    @XmlElement(name = "Description", namespace = "http://treasury.ge.com/schemas/ALOC/ADHOC/MyReports.xsd")
    protected String description;
    @XmlElement(name = "Created", namespace = "http://treasury.ge.com/schemas/ALOC/ADHOC/MyReports.xsd", type = String.class)
    @XmlJavaTypeAdapter(XMLDatetimeAsCalendarAdapter.class)
    protected Calendar created;
    @XmlElement(name = "LastSavedBy", namespace = "http://treasury.ge.com/schemas/ALOC/ADHOC/MyReports.xsd")
    protected String lastSavedBy;
    @XmlElement(name = "LastSaved", namespace = "http://treasury.ge.com/schemas/ALOC/ADHOC/MyReports.xsd", type = String.class)
    @XmlJavaTypeAdapter(XMLDatetimeAsCalendarAdapter.class)
    protected Calendar lastSaved;
    @XmlElement(name = "LastRun", namespace = "http://treasury.ge.com/schemas/ALOC/ADHOC/MyReports.xsd", type = String.class)
    @XmlJavaTypeAdapter(XMLDatetimeAsCalendarAdapter.class)
    ...
    public MyReports withReportID(BigInteger value) {
        setReportID(value);
        return this;
    }

    public MyReports withReportName(String value) {
        setReportName(value);
        return this;
    }

    public MyReports withDescription(String value) {
        setDescription(value);
        return this;
    }

    public MyReports withCreated(Calendar value) {
        setCreated(value);
        return this;
    }

    public MyReports withLastSavedBy(String value) {
        setLastSavedBy(value);
        return this;
    }

    public MyReports withLastSaved(Calendar value) {
        setLastSaved(value);
        return this;
    }

    public MyReports withLastRun(Calendar value) {
        setLastRun(value);
        return this;
    }
