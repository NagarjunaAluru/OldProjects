 ...
 * Purpose: CompositePdfPageEventHelper used to generate header and footer and Table of contents
 */
...
/**
 * This is composite Event Helper to generate header and footer and Table of contents
 * @author cnarvan
 */
public class CompositePdfPageEventHelper extends PdfPageEventHelper {
	...
	public CompositePdfPageEventHelper(PdfPageEventHelper... listeners) {
		...
		if (this.listeners == null) {
			this.listeners = new PdfPageEventHelper[ALOCConstants.BASE_VALUE];
		}
	}
