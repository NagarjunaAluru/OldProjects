 ...
 * FileName: NumberToWordsHelper.java
 * Purpose: NumberToWordsHelper used for Converting a Number into Words
 */
...
public class NumberToWordsHelper {
     ...
     * ScaleUnit
     */
    static private ScaleUnit[] scaleUnits = new ScaleUnit[] {
    ...
    static public class DefaultProcessor extends AbstractProcessor {
        ...
        static private String unionAnd = "and";

        static private String zeroToken = "zero";
        ...
        public String getName(String value) {
            ...
            if (!(null == decimalValue || decimalValue.isEmpty())) {
                name = name.concat(SEPARATOR).concat(unionAnd).concat(SEPARATOR)
    ...
    /**
     * This is the method used to get the number in words
     * @param number
     * @return
     */
    public static String getAmountInWords(String number){
		   AbstractProcessor processor = new DefaultProcessor();
		   String numberToWords =  processor.getName(number);		  
